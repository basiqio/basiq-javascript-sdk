...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BadRequestError', 'model/CreateUser', 'model/ForbiddenAccessError', 'model/InternalServerError', 'model/NotFoundError', 'model/StatusServiceUnavailableError', 'model/UnauthorizedError', 'model/UpdateUser', 'model/UserGetResponse', 'model/UserPostResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BadRequestError'), require('../model/CreateUser'), require('../model/ForbiddenAccessError'), require('../model/InternalServerError'), require('../model/NotFoundError'), require('../model/StatusServiceUnavailableError'), require('../model/UnauthorizedError'), require('../model/UpdateUser'), require('../model/UserGetResponse'), require('../model/UserPostResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.UsersApi = factory(root.BasiqApi.ApiClient, root.BasiqApi.BadRequestError, root.BasiqApi.CreateUser, root.BasiqApi.ForbiddenAccessError, root.BasiqApi.InternalServerError, root.BasiqApi.NotFoundError, root.BasiqApi.StatusServiceUnavailableError, root.BasiqApi.UnauthorizedError, root.BasiqApi.UpdateUser, root.BasiqApi.UserGetResponse, root.BasiqApi.UserPostResponse);
  }
}(this, function(ApiClient, BadRequestError, CreateUser, ForbiddenAccessError, InternalServerError, NotFoundError, StatusServiceUnavailableError, UnauthorizedError, UpdateUser, UserGetResponse, UserPostResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/UserPostResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Use this to create a new user object.
     * @param {module:model/CreateUser} user 
     ...
     * data is of type: {@link module:model/UserPostResponse}
     */
     ...
     * @param {String} userId The identifier of the user to be retrieved.
    ...
    this.getUser = function(userId, callback) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = UserGetResponse;
     ...
     * @param {String} userId The identifier of the user to be retrieved.
     * @param {module:model/UpdateUser} user 
