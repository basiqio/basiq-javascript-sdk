...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BadRequestError', 'model/ForbiddenAccessError', 'model/InternalServerError', 'model/NotFoundError', 'model/StatusServiceUnavailableError', 'model/TransactionData', 'model/TransactionsGetResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BadRequestError'), require('../model/ForbiddenAccessError'), require('../model/InternalServerError'), require('../model/NotFoundError'), require('../model/StatusServiceUnavailableError'), require('../model/TransactionData'), require('../model/TransactionsGetResource'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.TransactionsApi = factory(root.BasiqApi.ApiClient, root.BasiqApi.BadRequestError, root.BasiqApi.ForbiddenAccessError, root.BasiqApi.InternalServerError, root.BasiqApi.NotFoundError, root.BasiqApi.StatusServiceUnavailableError, root.BasiqApi.TransactionData, root.BasiqApi.TransactionsGetResource);
  }
}(this, function(ApiClient, BadRequestError, ForbiddenAccessError, InternalServerError, NotFoundError, StatusServiceUnavailableError, TransactionData, TransactionsGetResource) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/TransactionData} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/TransactionData}
     */
    this.getTransaction = function(userId, transactionId, callback) {
      var postBody = null;

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling getTransaction");
      }
      ...
      var returnType = TransactionData;

      return this.apiClient.callApi(
        '/users/{userId}/transactions/{transactionId}', 'GET',
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/TransactionsGetResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.limit This represents the maximum number of items that may be included in the response (maximum of 500). Note that by default 500 items are returned if this value is not specified. (default to 500)
     * @param {module:model/String} opts.filter Transaction filters.
     ...
     * data is of type: {@link module:model/TransactionsGetResource}
     */
    this.getTransactions = function(userId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling getTransactions");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = TransactionsGetResource;

      return this.apiClient.callApi(
        '/users/{userId}/transactions', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
