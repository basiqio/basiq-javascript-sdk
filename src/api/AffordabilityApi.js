...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AffordabilityPostRequest', 'model/AffordabilityResponse', 'model/AffordabilityTransactionsResponse', 'model/BadRequestError', 'model/ForbiddenAccessError', 'model/InternalServerError', 'model/NotFoundError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AffordabilityPostRequest'), require('../model/AffordabilityResponse'), require('../model/AffordabilityTransactionsResponse'), require('../model/BadRequestError'), require('../model/ForbiddenAccessError'), require('../model/InternalServerError'), require('../model/NotFoundError'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.AffordabilityApi = factory(root.BasiqApi.ApiClient, root.BasiqApi.AffordabilityPostRequest, root.BasiqApi.AffordabilityResponse, root.BasiqApi.AffordabilityTransactionsResponse, root.BasiqApi.BadRequestError, root.BasiqApi.ForbiddenAccessError, root.BasiqApi.InternalServerError, root.BasiqApi.NotFoundError);
  }
}(this, function(ApiClient, AffordabilityPostRequest, AffordabilityResponse, AffordabilityTransactionsResponse, BadRequestError, ForbiddenAccessError, InternalServerError, NotFoundError) {
  'use strict';

  /**
   * Affordability service.
   * @module api/AffordabilityApi
   * @version 2.0.0
   */

  /**
   * Constructs a new AffordabilityApi. 
   * @alias module:api/AffordabilityApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the getAffordability operation.
     * @callback module:api/AffordabilityApi~getAffordabilityCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AffordabilityResponse} data The data returned by the service call.
     ...
     * @param {String} snapshotId The identifier of the affordability report to be retrieved.
     * @param {module:api/AffordabilityApi~getAffordabilityCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AffordabilityResponse}
     */
    this.getAffordability = function(userId, snapshotId, callback) {
      var postBody = null;

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling getAffordability");
      }

      // verify the required parameter 'snapshotId' is set
      if (snapshotId === undefined || snapshotId === null) {
        throw new Error("Missing the required parameter 'snapshotId' when calling getAffordability");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json', 'application/pdf'];
      var returnType = AffordabilityResponse;

      return this.apiClient.callApi(
        '/users/{userId}/affordability/{snapshotId}', 'GET',
    ...
    /**
     * Callback function to receive the result of the getAffordabilitySnapshotTransactions operation.
     * @callback module:api/AffordabilityApi~getAffordabilitySnapshotTransactionsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AffordabilityTransactionsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.limit This represents the maximum number of transactions that may be included in the response (maximum of 500). Note that by default 500 transactions are returned if this value is not specified.
     * @param {module:api/AffordabilityApi~getAffordabilitySnapshotTransactionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AffordabilityTransactionsResponse}
     */
    this.getAffordabilitySnapshotTransactions = function(userId, snapshotId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling getAffordabilitySnapshotTransactions");
      }

      // verify the required parameter 'snapshotId' is set
      if (snapshotId === undefined || snapshotId === null) {
        throw new Error("Missing the required parameter 'snapshotId' when calling getAffordabilitySnapshotTransactions");
      }
      ...
      var authNames = ['application'];
      var contentTypes = [];
      var accepts = ['application/json', 'application/csv'];
      var returnType = AffordabilityTransactionsResponse;

      return this.apiClient.callApi(
        '/users/{userId}/affordability/{snapshotId}/transactions', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the postAffordability operation.
     * @callback module:api/AffordabilityApi~postAffordabilityCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AffordabilityResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} userId The identifier of the user.
     * @param {Object} opts Optional parameters
     * @param {module:model/AffordabilityPostRequest} opts.affordabilityPostRequest 
     * @param {module:api/AffordabilityApi~postAffordabilityCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AffordabilityResponse}
     */
    this.postAffordability = function(userId, opts, callback) {
      opts = opts || {};
      var postBody = opts['affordabilityPostRequest'];

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling postAffordability");
      }
      ...
      return this.apiClient.callApi(
        '/users/{userId}/affordability', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
