...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AuthLinksPostData', 'model/AuthLinksPostResponseResource', 'model/AuthLinksResponseResource', 'model/BadRequestError', 'model/ForbiddenAccessError', 'model/GoneError', 'model/InternalServerError', 'model/NotFoundError', 'model/StatusServiceUnavailableError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AuthLinksPostResponseResource'), require('../model/AuthLinksResponseResource'), require('../model/BadRequestError'), require('../model/ForbiddenAccessError'), require('../model/GoneError'), require('../model/InternalServerError'), require('../model/NotFoundError'), require('../model/StatusServiceUnavailableError'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.AuthLinksApi = factory(root.BasiqApi.ApiClient, root.BasiqApi.AuthLinksPostData, root.BasiqApi.AuthLinksPostResponseResource, root.BasiqApi.AuthLinksResponseResource, root.BasiqApi.BadRequestError, root.BasiqApi.ForbiddenAccessError, root.BasiqApi.GoneError, root.BasiqApi.InternalServerError, root.BasiqApi.NotFoundError, root.BasiqApi.StatusServiceUnavailableError);
  }
}(this, function(ApiClient, AuthLinksPostData, AuthLinksPostResponseResource, AuthLinksResponseResource, BadRequestError, ForbiddenAccessError, GoneError, InternalServerError, NotFoundError, StatusServiceUnavailableError) {
  'use strict';

  /**
   * AuthLinks service.
   * @module api/AuthLinksApi
   * @version 2.0.0
   */

  /**
   * Constructs a new AuthLinksApi. 
   * @alias module:api/AuthLinksApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the deleteAuthLink operation.
     * @callback module:api/AuthLinksApi~deleteAuthLinkCallback
     ...
     * @param {module:api/AuthLinksApi~deleteAuthLinkCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.deleteAuthLink = function(userId, callback) {
      var postBody = null;

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling deleteAuthLink");
      }
    ...
    /**
     * Callback function to receive the result of the getAuthLink operation.
     * @callback module:api/AuthLinksApi~getAuthLinkCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AuthLinksResponseResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} userId The identifier of the user.
     * @param {module:api/AuthLinksApi~getAuthLinkCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AuthLinksResponseResource}
     */
    this.getAuthLink = function(userId, callback) {
      var postBody = null;

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling getAuthLink");
      }
      ...
      var returnType = AuthLinksResponseResource;

      return this.apiClient.callApi(
        '/users/{userId}/auth_link', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the postAuthLink operation.
     * @callback module:api/AuthLinksApi~postAuthLinkCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AuthLinksPostResponseResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/AuthLinksPostData} opts.authLinksPostData 
     * @param {module:api/AuthLinksApi~postAuthLinkCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AuthLinksPostResponseResource}
     */
    this.postAuthLink = function(userId, opts, callback) {
      opts = opts || {};
      var postBody = opts['authLinksPostData'];

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling postAuthLink");
      }
      ...
      var accepts = ['application/json'];
      var returnType = AuthLinksPostResponseResource;

      return this.apiClient.callApi(
        '/users/{userId}/auth_link', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
