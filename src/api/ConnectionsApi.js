...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BadRequestError', 'model/ConnectionGetResponseResource', 'model/ConnectionResponseResource', 'model/ConnectionsGetResponseResource', 'model/ConnectionsRefreshResource', 'model/ForbiddenAccessError', 'model/InternalServerError', 'model/NotFoundError', 'model/StatusServiceUnavailableError', 'model/UnauthorizedError', 'model/UnsupportedMediaTypeError', 'model/UserConnectionPostData', 'model/UserConnectionsPostData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BadRequestError'), require('../model/ConnectionGetResponseResource'), require('../model/ConnectionResponseResource'), require('../model/ConnectionsGetResponseResource'), require('../model/ConnectionsRefreshResource'), require('../model/ForbiddenAccessError'), require('../model/InternalServerError'), require('../model/NotFoundError'), require('../model/StatusServiceUnavailableError'), require('../model/UnauthorizedError'), require('../model/UnsupportedMediaTypeError'), require('../model/UserConnectionPostData'), require('../model/UserConnectionsPostData'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.ConnectionsApi = factory(root.BasiqApi.ApiClient, root.BasiqApi.BadRequestError, root.BasiqApi.ConnectionGetResponseResource, root.BasiqApi.ConnectionResponseResource, root.BasiqApi.ConnectionsGetResponseResource, root.BasiqApi.ConnectionsRefreshResource, root.BasiqApi.ForbiddenAccessError, root.BasiqApi.InternalServerError, root.BasiqApi.NotFoundError, root.BasiqApi.StatusServiceUnavailableError, root.BasiqApi.UnauthorizedError, root.BasiqApi.UnsupportedMediaTypeError, root.BasiqApi.UserConnectionPostData, root.BasiqApi.UserConnectionsPostData);
  }
}(this, function(ApiClient, BadRequestError, ConnectionGetResponseResource, ConnectionResponseResource, ConnectionsGetResponseResource, ConnectionsRefreshResource, ForbiddenAccessError, InternalServerError, NotFoundError, StatusServiceUnavailableError, UnauthorizedError, UnsupportedMediaTypeError, UserConnectionPostData, UserConnectionsPostData) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/ConnectionsApi~deleteConnectionCallback
     ...
     * @param {String} connectionId The identifier of the connection.
     * @param {module:api/ConnectionsApi~deleteConnectionCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.deleteConnection = function(userId, connectionId, callback) {
      var postBody = null;

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling deleteConnection");
      }
      ...
      return this.apiClient.callApi(
        '/users/{userId}/connections/{connectionId}', 'DELETE',
     ...
     * @callback module:api/ConnectionsApi~getConnectionCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ConnectionGetResponseResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} userId The identifier of the user.
     * @param {String} connectionId The identifier of the connection.
     * @param {module:api/ConnectionsApi~getConnectionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ConnectionGetResponseResource}
     */
    this.getConnection = function(userId, connectionId, callback) {
      var postBody = null;

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling getConnection");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ConnectionGetResponseResource;

      return this.apiClient.callApi(
        '/users/{userId}/connections/{connectionId}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/ConnectionsGetResponseResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.filter Connections filters, id, status, institution.id. e.g institution.id.eq('AU00000')
     ...
     * data is of type: {@link module:model/ConnectionsGetResponseResource}
     */
    this.getConnections = function(userId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling getConnections");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ConnectionsGetResponseResource;

      return this.apiClient.callApi(
        '/users/{userId}/connections', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * @callback module:api/ConnectionsApi~postConnectionCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ConnectionResponseResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} userId The identifier of the user.
     * @param {Object} opts Optional parameters
     * @param {module:model/UserConnectionsPostData} opts.userConnectionsPostData 
     * @param {module:api/ConnectionsApi~postConnectionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ConnectionResponseResource}
     */
    this.postConnection = function(userId, opts, callback) {
      opts = opts || {};
      var postBody = opts['userConnectionsPostData'];

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling postConnection");
      }
      ...
      var accepts = ['application/json'];
      var returnType = ConnectionResponseResource;

      return this.apiClient.callApi(
        '/users/{userId}/connections', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the refreshConnection operation.
     * @callback module:api/ConnectionsApi~refreshConnectionCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ConnectionResponseResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} userId The identifier of the user.
     * @param {String} connectionId The identifier of the connection.
     * @param {module:api/ConnectionsApi~refreshConnectionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ConnectionResponseResource}
     */
    this.refreshConnection = function(userId, connectionId, callback) {
      var postBody = null;

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling refreshConnection");
      }

      // verify the required parameter 'connectionId' is set
      if (connectionId === undefined || connectionId === null) {
        throw new Error("Missing the required parameter 'connectionId' when calling refreshConnection");
      }
      ...
      return this.apiClient.callApi(
        '/users/{userId}/connections/{connectionId}/refresh', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the refreshConnections operation.
     * @callback module:api/ConnectionsApi~refreshConnectionsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ConnectionsRefreshResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} userId The identifier of the user.
     * @param {module:api/ConnectionsApi~refreshConnectionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ConnectionsRefreshResource}
     */
    this.refreshConnections = function(userId, callback) {
      var postBody = null;

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling refreshConnections");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ConnectionsRefreshResource;

      return this.apiClient.callApi(
        '/users/{userId}/connections/refresh', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * @callback module:api/ConnectionsApi~updateConnectionCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ConnectionResponseResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/UserConnectionPostData} opts.userConnectionPostData 
     * @param {module:api/ConnectionsApi~updateConnectionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ConnectionResponseResource}
     */
    this.updateConnection = function(userId, connectionId, opts, callback) {
      opts = opts || {};
      var postBody = opts['userConnectionPostData'];

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling updateConnection");
      }

      // verify the required parameter 'connectionId' is set
      if (connectionId === undefined || connectionId === null) {
        throw new Error("Missing the required parameter 'connectionId' when calling updateConnection");
      }
      ...
      return this.apiClient.callApi(
        '/users/{userId}/connections/{connectionId}', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
