...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccountResponseResource', 'model/AccountsResponseResource', 'model/BadRequestError', 'model/ForbiddenAccessError', 'model/InternalServerError', 'model/NotFoundError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AccountResponseResource'), require('../model/AccountsResponseResource'), require('../model/BadRequestError'), require('../model/ForbiddenAccessError'), require('../model/InternalServerError'), require('../model/NotFoundError'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.AccountsApi = factory(root.BasiqApi.ApiClient, root.BasiqApi.AccountResponseResource, root.BasiqApi.AccountsResponseResource, root.BasiqApi.BadRequestError, root.BasiqApi.ForbiddenAccessError, root.BasiqApi.InternalServerError, root.BasiqApi.NotFoundError);
  }
}(this, function(ApiClient, AccountResponseResource, AccountsResponseResource, BadRequestError, ForbiddenAccessError, InternalServerError, NotFoundError) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/AccountResponseResource} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/AccountResponseResource}
     */
    this.getAccount = function(userId, accountId, callback) {
      var postBody = null;

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling getAccount");
      }
      ...
      var returnType = AccountResponseResource;

      return this.apiClient.callApi(
        '/users/{userId}/accounts/{accountId}', 'GET',
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/AccountsResponseResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/AccountsResponseResource}
     */
    this.getAccounts = function(userId, callback) {
      var postBody = null;

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling getAccounts");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = AccountsResponseResource;

      return this.apiClient.callApi(
        '/users/{userId}/accounts', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
