...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BadRequestError', 'model/ForbiddenAccessError', 'model/InternalServerError', 'model/JobData', 'model/JobsResponseResource', 'model/NotFoundError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BadRequestError'), require('../model/ForbiddenAccessError'), require('../model/InternalServerError'), require('../model/JobData'), require('../model/JobsResponseResource'), require('../model/NotFoundError'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.JobsApi = factory(root.BasiqApi.ApiClient, root.BasiqApi.BadRequestError, root.BasiqApi.ForbiddenAccessError, root.BasiqApi.InternalServerError, root.BasiqApi.JobData, root.BasiqApi.JobsResponseResource, root.BasiqApi.NotFoundError);
  }
}(this, function(ApiClient, BadRequestError, ForbiddenAccessError, InternalServerError, JobData, JobsResponseResource, NotFoundError) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/JobData} data The data returned by the service call.
     ...
     * @param {String} jobId The identifier of the job to be retrieved.
     * @param {module:api/JobsApi~getJobsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JobData}
     */
    this.getJobs = function(jobId, callback) {
      var postBody = null;

      // verify the required parameter 'jobId' is set
      if (jobId === undefined || jobId === null) {
        throw new Error("Missing the required parameter 'jobId' when calling getJobs");
      }
     ...
     * @callback module:api/JobsApi~getUserJobsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/JobsResponseResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.filter Connection identification filter. e.g. connection.id.eq('ab63cd')
     * @param {module:api/JobsApi~getUserJobsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JobsResponseResource}
     */
    this.getUserJobs = function(userId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling getUserJobs");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = JobsResponseResource;

      return this.apiClient.callApi(
        '/users/{userId}/jobs', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
