...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BadRequestError', 'model/ExpensesPostRequest', 'model/ExpensesResponse', 'model/ForbiddenAccessError', 'model/InternalServerError', 'model/NotFoundError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BadRequestError'), require('../model/ExpensesPostRequest'), require('../model/ExpensesResponse'), require('../model/ForbiddenAccessError'), require('../model/InternalServerError'), require('../model/NotFoundError'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.ExpensesApi = factory(root.BasiqApi.ApiClient, root.BasiqApi.BadRequestError, root.BasiqApi.ExpensesPostRequest, root.BasiqApi.ExpensesResponse, root.BasiqApi.ForbiddenAccessError, root.BasiqApi.InternalServerError, root.BasiqApi.NotFoundError);
  }
}(this, function(ApiClient, BadRequestError, ExpensesPostRequest, ExpensesResponse, ForbiddenAccessError, InternalServerError, NotFoundError) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/ExpensesApi~getExpensesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ExpensesResponse} data The data returned by the service call.
     ...
     * @param {String} snapshotId The identifier of the expenses report to be retrieved.
     * @param {module:api/ExpensesApi~getExpensesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ExpensesResponse}
     */
    this.getExpenses = function(userId, snapshotId, callback) {
      var postBody = null;

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling getExpenses");
      }

      // verify the required parameter 'snapshotId' is set
      if (snapshotId === undefined || snapshotId === null) {
        throw new Error("Missing the required parameter 'snapshotId' when calling getExpenses");
      }
      ...
      var returnType = ExpensesResponse;

      return this.apiClient.callApi(
        '/users/{userId}/expenses/{snapshotId}', 'GET',
    ...
    /**
     * Callback function to receive the result of the postExpenses operation.
     * @callback module:api/ExpensesApi~postExpensesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ExpensesResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/ExpensesPostRequest} opts.expensesPostRequest 
     * @param {module:api/ExpensesApi~postExpensesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ExpensesResponse}
     */
    this.postExpenses = function(userId, opts, callback) {
      opts = opts || {};
      var postBody = opts['expensesPostRequest'];

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling postExpenses");
      }
