...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BadRequestError', 'model/Institution', 'model/InstitutionsList', 'model/InternalServerError', 'model/NotFoundError', 'model/UnauthorizedError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BadRequestError'), require('../model/Institution'), require('../model/InstitutionsList'), require('../model/InternalServerError'), require('../model/NotFoundError'), require('../model/UnauthorizedError'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.InstitutionsApi = factory(root.BasiqApi.ApiClient, root.BasiqApi.BadRequestError, root.BasiqApi.Institution, root.BasiqApi.InstitutionsList, root.BasiqApi.InternalServerError, root.BasiqApi.NotFoundError, root.BasiqApi.UnauthorizedError);
  }
}(this, function(ApiClient, BadRequestError, Institution, InstitutionsList, InternalServerError, NotFoundError, UnauthorizedError) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getInstitution = function(institutionID, callback) {
      var postBody = null;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/InstitutionsList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/InstitutionsList}
     */
    this.getInstitutions = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = InstitutionsList;
    ...
    /**
     * Callback function to receive the result of the getPublicInstitutions operation.
     * @callback module:api/InstitutionsApi~getPublicInstitutionsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InstitutionsList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.filter Filter parameter can be used to filter institution list by institution property. This parameter should contain comma separated list of filter statements.</br> Filter statement is composed from entity name (in this case it is always `institution`), property name (e.g. `stage`), filter operator (e.g. `eq`) and quoted string value in parentasis (e.g. `('live')`). </br> The Following list of regular expressions descirbes acceptable filter statements: </br> • `institution\\.country\\.(eq|ne)\\(('Australia'|'New Zealand')\\)` </br> • `institution\\.country\\.in\\(([\\w\\W]+)\\)` </br> • `institution\\.tier\\.(eq|ne)\\(('1'|'2'|'3'|'4')\\)` </br> • `institution\\.tier\\.in\\('[1-4]'(,'[1-4]')*\\)` </br> • `institution\\.authorization\\.(eq|ne)\\(('user'|'other')\\)` </br> • `institution\\.serviceType\\.(eq|ne)\\(('Personal Banking'|'Business Banking'|'Card Access'|'Test')\\)` </br> • `institution\\.institutionType\\.(eq|ne)\\(('Bank'|'Bank \\(Foreign\\)'|'Test Bank'|'Credit Union'|'Financial Services'|'Superannuation')\\)` </br> • `institution\\.stage\\.(eq|ne)\\(('live'|'beta'|'alpha')\\)` </br> Multiple filter definitions should be separated with comma (`,`). </br> For example, this is filter statement will keep only live tier 1 and tier 2 institutions: `filter=institution.stage.eq('live'),institution.tier.in('1','2')` </br>
     * @param {module:api/InstitutionsApi~getPublicInstitutionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InstitutionsList}
     */
    this.getPublicInstitutions = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
