...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BadRequestError', 'model/ForbiddenAccessError', 'model/IncomePostRequest', 'model/IncomeResponse', 'model/InternalServerError', 'model/NotFoundError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BadRequestError'), require('../model/ForbiddenAccessError'), require('../model/IncomePostRequest'), require('../model/IncomeResponse'), require('../model/InternalServerError'), require('../model/NotFoundError'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.IncomeApi = factory(root.BasiqApi.ApiClient, root.BasiqApi.BadRequestError, root.BasiqApi.ForbiddenAccessError, root.BasiqApi.IncomePostRequest, root.BasiqApi.IncomeResponse, root.BasiqApi.InternalServerError, root.BasiqApi.NotFoundError);
  }
}(this, function(ApiClient, BadRequestError, ForbiddenAccessError, IncomePostRequest, IncomeResponse, InternalServerError, NotFoundError) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the getIncome operation.
     * @callback module:api/IncomeApi~getIncomeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IncomeResponse} data The data returned by the service call.
     ...
     * @param {String} snapshotId The identifier of the income report to be retrieved.
     * @param {module:api/IncomeApi~getIncomeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IncomeResponse}
     */
    this.getIncome = function(userId, snapshotId, callback) {
      var postBody = null;

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling getIncome");
      }

      // verify the required parameter 'snapshotId' is set
      if (snapshotId === undefined || snapshotId === null) {
        throw new Error("Missing the required parameter 'snapshotId' when calling getIncome");
      }
      ...
      var returnType = IncomeResponse;

      return this.apiClient.callApi(
        '/users/{userId}/income/{snapshotId}', 'GET',
    ...
    /**
     * Callback function to receive the result of the postIncome operation.
     * @callback module:api/IncomeApi~postIncomeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IncomeResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/IncomePostRequest} opts.incomePostRequest 
     * @param {module:api/IncomeApi~postIncomeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IncomeResponse}
     */
    this.postIncome = function(userId, opts, callback) {
      opts = opts || {};
      var postBody = opts['incomePostRequest'];

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling postIncome");
      }
