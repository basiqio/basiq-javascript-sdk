...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/JobsResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./JobsResult'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.JobsStep = factory(root.BasiqApi.ApiClient, root.BasiqApi.JobsResult);
  }
}(this, function(ApiClient, JobsResult) {
  'use strict';

  /**
   * The JobsStep model module.
   * @module model/JobsStep
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>JobsStep</code>.
   * List of steps that need to be completed.
   * @alias module:model/JobsStep
   * @class
   * @param result {module:model/JobsResult} 
   * @param status {module:model/JobsStep.StatusEnum} Step status. <ul> <li> pending -  The job has been created and is waiting to be started.</li> <li> in-progress - The job has started and is currently processing.</li> <li> success - The job has successfully completed. </li> <li> failed - The job has failed.</li> </ul>
   */
  var exports = function(result, status) {
    this.result = result;
    this.status = status;
  };

  /**
   * Constructs a <code>JobsStep</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/JobsStep} obj Optional instance to populate.
   * @return {module:model/JobsStep} The populated <code>JobsStep</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('result'))
        obj.result = JobsResult.constructFromObject(data['result']);
  ...
  /**
   * @member {module:model/JobsResult} result
   */
  exports.prototype.result = undefined;

  /**
   * Step status. <ul> <li> pending -  The job has been created and is waiting to be started.</li> <li> in-progress - The job has started and is currently processing.</li> <li> success - The job has successfully completed. </li> <li> failed - The job has failed.</li> </ul>
   * @member {module:model/JobsStep.StatusEnum} status
   */
  exports.prototype.status = undefined;

  /**
   * Name of the step the job needs to complete.
   * @member {module:model/JobsStep.TitleEnum} title
   */
