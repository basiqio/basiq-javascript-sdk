...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SubClass', 'model/TransactionLinks', 'model/TransactionsEnrich'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SubClass'), require('./TransactionLinks'), require('./TransactionsEnrich'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.TransactionData = factory(root.BasiqApi.ApiClient, root.BasiqApi.SubClass, root.BasiqApi.TransactionLinks, root.BasiqApi.TransactionsEnrich);
  }
}(this, function(ApiClient, SubClass, TransactionLinks, TransactionsEnrich) {
  'use strict';
   ...
   * @class
   * @param account {String} The id of the account resource the transaction belongs to.
   * @param amount {String} Transaction amount. Outgoing funds are expressed as negative values.
   * @param balance {String} Value of the account balance at time the transaction was completed.
   * @param _class {module:model/TransactionData.ClassEnum} Describes the class(type) of transaction.
   * @param connection {String} The id of the connection resource that was used to retrieve the transaction.
   * @param description {String} The transaction description as submitted by the institution..
   * @param direction {module:model/TransactionData.DirectionEnum} Identifies if the transaction is of debit or credit type.
   * @param enrich {module:model/TransactionsEnrich} 
   * @param id {String} Uniquely identifies the transaction for this connection. Note that when a connection is refreshed pending transactions will receive new id's, whilst posted transactions will receive the same id's as before the refresh.
   * @param institution {String} The id of the institution resource the transaction originated from.
   * @param links {module:model/TransactionLinks} 
   * @param postDate {String} Date the transaction was posted as provided by the institution (this is the same date that appears on a bank statement). This value is null if the record is pending. e.g. \"2017-11-10T21:46:44Z\" or 2017-11-10T00:00:00Z.
   * @param status {module:model/TransactionData.StatusEnum} Identifies if a transaction is pending or posted. A pending transaction is an approved debit or credit transaction that has not been fully processed yet (i.e. has not been posted). Find out more about pending transaction and how to deal with them within your app. Note that pending transactions are not available for all institutions.
   * @param subClass {module:model/SubClass} 
   * @param transactionDate {String} Date that the user executed the transaction as provided by the istitution. Note that not all transactions provide this value (varies by institution) e.g. \"2017-11-10T00:00:00Z\"
   * @param type {String} Value is \"transaction\".
   */
  var exports = function(account, amount, balance, _class, connection, description, direction, enrich, id, institution, links, postDate, status, subClass, transactionDate, type) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('enrich'))
        obj.enrich = TransactionsEnrich.constructFromObject(data['enrich']);
      if (data.hasOwnProperty('id'))
        obj.id = ApiClient.convertToType(data['id'], 'String');
      if (data.hasOwnProperty('institution'))
        obj.institution = ApiClient.convertToType(data['institution'], 'String');
      if (data.hasOwnProperty('links'))
        obj.links = TransactionLinks.constructFromObject(data['links']);
      ...
      if (data.hasOwnProperty('subClass'))
        obj.subClass = SubClass.constructFromObject(data['subClass']);
   ...
   * @member {module:model/TransactionData.ClassEnum} _class
   */
   ...
   * @member {module:model/TransactionData.DirectionEnum} direction
   */
  exports.prototype.direction = undefined;

  /**
   * @member {module:model/TransactionsEnrich} enrich
   */
  exports.prototype.enrich = undefined;
  ...
  /**
   * @member {module:model/TransactionLinks} links
   */
   ...
   */
  exports.prototype.postDate = undefined;
   ...
   * @member {module:model/TransactionData.StatusEnum} status
   */
  exports.prototype.status = undefined;

  /**
   * @member {module:model/SubClass} subClass
   */
  exports.prototype.subClass = undefined;
  ...
  /**
   * Allowed values for the <code>_class</code> property.
   * @enum {String}
   * @readonly
   */
  exports.ClassEnum = {
