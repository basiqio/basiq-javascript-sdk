...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccountHolder', 'model/AssetsPrevious6MonthsData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AccountHolder'), require('./AssetsPrevious6MonthsData'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.AffordabilityAssetsData = factory(root.BasiqApi.ApiClient, root.BasiqApi.AccountHolder, root.BasiqApi.AssetsPrevious6MonthsData);
  }
}(this, function(ApiClient, AccountHolder, AssetsPrevious6MonthsData) {
  'use strict';

  /**
   * The AffordabilityAssetsData model module.
   * @module model/AffordabilityAssetsData
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>AffordabilityAssetsData</code>.
   * @alias module:model/AffordabilityAssetsData
   * @class
   * @param account {module:model/AccountHolder} 
   * @param availableFunds {String} The available funds at the time of the query.
   * @param balance {String} The currency in which the account is recorded.
   ...
   * @param previous6Months {module:model/AssetsPrevious6MonthsData} 
   * @param type {String} Type account
   */
  var exports = function(account, availableFunds, balance, currency, institution, previous6Months, type) {
  ...
  /**
   * Constructs a <code>AffordabilityAssetsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AffordabilityAssetsData} obj Optional instance to populate.
   * @return {module:model/AffordabilityAssetsData} The populated <code>AffordabilityAssetsData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('previous6Months'))
        obj.previous6Months = AssetsPrevious6MonthsData.constructFromObject(data['previous6Months']);
  ...
  /**
   * @member {module:model/AssetsPrevious6MonthsData} previous6Months
   */
