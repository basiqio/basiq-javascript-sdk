...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccountHolder', 'model/ChangeHistoryAffordabilityData', 'model/Previous6MonthsLoan', 'model/PreviousMonthDataLoanLiabilities'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AccountHolder'), require('./ChangeHistoryAffordabilityData'), require('./Previous6MonthsLoan'), require('./PreviousMonthDataLoanLiabilities'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.LoanLiabilities = factory(root.BasiqApi.ApiClient, root.BasiqApi.AccountHolder, root.BasiqApi.ChangeHistoryAffordabilityData, root.BasiqApi.Previous6MonthsLoan, root.BasiqApi.PreviousMonthDataLoanLiabilities);
  }
}(this, function(ApiClient, AccountHolder, ChangeHistoryAffordabilityData, Previous6MonthsLoan, PreviousMonthDataLoanLiabilities) {
  'use strict';

  /**
   * The LoanLiabilities model module.
   * @module model/LoanLiabilities
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>LoanLiabilities</code>.
   * @alias module:model/LoanLiabilities
   * @class
   * @param account {module:model/AccountHolder} 
   * @param availableFunds {String} The available funds at the time of the query.
   * @param balance {String} The balance at the time of the query.
   * @param changeHistory {Array.<module:model/ChangeHistoryAffordabilityData>} List of account transactions changes
   * @param currency {String} The currency in which the account is recorded.
   * @param institution {String} The name of the financial institution with whom the account is held.
   * @param previous6Months {module:model/Previous6MonthsLoan} 
   * @param previousMonth {module:model/PreviousMonthDataLoanLiabilities} 
   */
  var exports = function(account, availableFunds, balance, changeHistory, currency, institution, previous6Months, previousMonth) {
    ...
    this.previous6Months = previous6Months;
    this.previousMonth = previousMonth;
  };

  /**
   * Constructs a <code>LoanLiabilities</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LoanLiabilities} obj Optional instance to populate.
   * @return {module:model/LoanLiabilities} The populated <code>LoanLiabilities</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('account'))
        obj.account = AccountHolder.constructFromObject(data['account']);
      ...
      if (data.hasOwnProperty('changeHistory'))
        obj.changeHistory = ApiClient.convertToType(data['changeHistory'], [ChangeHistoryAffordabilityData]);
      if (data.hasOwnProperty('currency'))
        obj.currency = ApiClient.convertToType(data['currency'], 'String');
      if (data.hasOwnProperty('institution'))
        obj.institution = ApiClient.convertToType(data['institution'], 'String');
      if (data.hasOwnProperty('previous6Months'))
        obj.previous6Months = Previous6MonthsLoan.constructFromObject(data['previous6Months']);
      if (data.hasOwnProperty('previousMonth'))
        obj.previousMonth = PreviousMonthDataLoanLiabilities.constructFromObject(data['previousMonth']);
    }
    return obj;
  }

  /**
   * @member {module:model/AccountHolder} account
   */
   ...
   * @member {Array.<module:model/ChangeHistoryAffordabilityData>} changeHistory
   */
  ...
  /**
   * @member {module:model/Previous6MonthsLoan} previous6Months
   */
  exports.prototype.previous6Months = undefined;

  /**
   * @member {module:model/PreviousMonthDataLoanLiabilities} previousMonth
   */
  exports.prototype.previousMonth = undefined;
