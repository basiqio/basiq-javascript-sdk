...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ClassResourceExpenses', 'model/ExpensesLinks', 'model/PaymentsSummaryExpenses'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ClassResourceExpenses'), require('./ExpensesLinks'), require('./PaymentsSummaryExpenses'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.ExpensesResponse = factory(root.BasiqApi.ApiClient, root.BasiqApi.ClassResourceExpenses, root.BasiqApi.ExpensesLinks, root.BasiqApi.PaymentsSummaryExpenses);
  }
}(this, function(ApiClient, ClassResourceExpenses, ExpensesLinks, PaymentsSummaryExpenses) {
  'use strict';

  /**
   * The ExpensesResponse model module.
   * @module model/ExpensesResponse
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>ExpensesResponse</code>.
   * Container object, containing expenses details.  The Expenses object returns an aggregated list of expenses by category of spend.
   * @alias module:model/ExpensesResponse
   * @class
   * @param bankFees {module:model/ClassResourceExpenses} 
   * @param cashWithdrawals {module:model/ClassResourceExpenses} 
   * @param externalTransfers {module:model/ClassResourceExpenses} 
   * @param fromMonth {String} First 'month' occurrence of expenses categorised going back as far as 13 months.
   * @param id {String} Uniquely identifies the expenses report.
   * @param loanInterests {module:model/ClassResourceExpenses} 
   * @param loanRepayments {module:model/ClassResourceExpenses} 
   * @param payments {Array.<module:model/PaymentsSummaryExpenses>} 
   * @param toMonth {String} Latest 'month' occurrence of expenses categorised.
   * @param type {String} Value of this resource is \"expenses\".
   */
  var exports = function(bankFees, cashWithdrawals, externalTransfers, fromMonth, id, loanInterests, loanRepayments, payments, toMonth, type) {
  ...
  /**
   * Constructs a <code>ExpensesResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ExpensesResponse} obj Optional instance to populate.
   * @return {module:model/ExpensesResponse} The populated <code>ExpensesResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('bankFees'))
        obj.bankFees = ClassResourceExpenses.constructFromObject(data['bankFees']);
      if (data.hasOwnProperty('cashWithdrawals'))
        obj.cashWithdrawals = ClassResourceExpenses.constructFromObject(data['cashWithdrawals']);
      if (data.hasOwnProperty('coverageDays'))
        obj.coverageDays = ApiClient.convertToType(data['coverageDays'], 'Number');
      if (data.hasOwnProperty('externalTransfers'))
        obj.externalTransfers = ClassResourceExpenses.constructFromObject(data['externalTransfers']);
      if (data.hasOwnProperty('fromMonth'))
        obj.fromMonth = ApiClient.convertToType(data['fromMonth'], 'String');
      if (data.hasOwnProperty('id'))
        obj.id = ApiClient.convertToType(data['id'], 'String');
      if (data.hasOwnProperty('links'))
        obj.links = ExpensesLinks.constructFromObject(data['links']);
      if (data.hasOwnProperty('loanInterests'))
        obj.loanInterests = ClassResourceExpenses.constructFromObject(data['loanInterests']);
      if (data.hasOwnProperty('loanRepayments'))
        obj.loanRepayments = ClassResourceExpenses.constructFromObject(data['loanRepayments']);
      if (data.hasOwnProperty('payments'))
        obj.payments = ApiClient.convertToType(data['payments'], [PaymentsSummaryExpenses]);
      if (data.hasOwnProperty('toMonth'))
        obj.toMonth = ApiClient.convertToType(data['toMonth'], 'String');
  ...
  /**
   * @member {module:model/ClassResourceExpenses} bankFees
   */
  exports.prototype.bankFees = undefined;

  /**
   * @member {module:model/ClassResourceExpenses} cashWithdrawals
   */
  exports.prototype.cashWithdrawals = undefined;

  /**
   * Number of days covered by the report
   * @member {Number} coverageDays
   */
  exports.prototype.coverageDays = undefined;

  /**
   * @member {module:model/ClassResourceExpenses} externalTransfers
   */
  exports.prototype.externalTransfers = undefined;

  /**
   * First 'month' occurrence of expenses categorised going back as far as 13 months.
   * @member {String} fromMonth
   */
  exports.prototype.fromMonth = undefined;
  ...
  /**
   * @member {module:model/ExpensesLinks} links
   */
  exports.prototype.links = undefined;

  /**
   * @member {module:model/ClassResourceExpenses} loanInterests
   */
  exports.prototype.loanInterests = undefined;

  /**
   * @member {module:model/ClassResourceExpenses} loanRepayments
   */
  exports.prototype.loanRepayments = undefined;

  /**
   * @member {Array.<module:model/PaymentsSummaryExpenses>} payments
   */
  exports.prototype.payments = undefined;

  /**
   * Latest 'month' occurrence of expenses categorised.
   * @member {String} toMonth
   */
  exports.prototype.toMonth = undefined;
