...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/JobsLinks', 'model/JobsStep'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./JobsLinks'), require('./JobsStep'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.JobData = factory(root.BasiqApi.ApiClient, root.BasiqApi.JobsLinks, root.BasiqApi.JobsStep);
  }
}(this, function(ApiClient, JobsLinks, JobsStep) {
  'use strict';
   ...
   */
  var exports = function(created, id, steps, updated) {
