...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BasiqApi.ProfileFeatures = factory(root.BasiqApi.ApiClient, root.BasiqApi.SourceName);
  }
}(this, function(ApiClient, SourceName) {
  'use strict';

  /**
   * The ProfileFeatures model module.
   * @module model/ProfileFeatures
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>ProfileFeatures</code>.
   * ProfileFeatures describes set of institution profile features
   * @alias module:model/ProfileFeatures
   * @class
   * @param emailAddresses {Array.<module:model/SourceName>} EmailAddresses holds list of data source identifiers which are capable to fetch bank customer e-mail addresses.
   * @param firstName {Array.<module:model/SourceName>} FirstName holds list of data source identifiers which are capable to fetch bank customer first name.
   * @param fullName {Array.<module:model/SourceName>} FullName holds list of data source identifiers which are capable to fetch bank customer full name.
   * @param lastName {Array.<module:model/SourceName>} LastName holds list of data source identifiers which are capable to fetch bank customer last name.
   * @param middleName {Array.<module:model/SourceName>} MiddleName holds list of data source identifiers which are capable to fetch bank customer middle name.
   * @param phoneNumbers {Array.<module:model/SourceName>} PhoneNumbers holds list of data source identifiers which are capable to fetch bank customer phone number.
   * @param physicalAddresses {Array.<module:model/SourceName>} PhysicalAddresses holds list of data source identifiers which are capable to fetch bank customer physical addresses.
   */
  var exports = function(emailAddresses, firstName, fullName, lastName, middleName, phoneNumbers, physicalAddresses) {
  ...
  /**
   * Constructs a <code>ProfileFeatures</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProfileFeatures} obj Optional instance to populate.
   * @return {module:model/ProfileFeatures} The populated <code>ProfileFeatures</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('emailAddresses'))
        obj.emailAddresses = ApiClient.convertToType(data['emailAddresses'], [SourceName]);
      if (data.hasOwnProperty('firstName'))
        obj.firstName = ApiClient.convertToType(data['firstName'], [SourceName]);
      if (data.hasOwnProperty('fullName'))
        obj.fullName = ApiClient.convertToType(data['fullName'], [SourceName]);
      if (data.hasOwnProperty('lastName'))
        obj.lastName = ApiClient.convertToType(data['lastName'], [SourceName]);
      if (data.hasOwnProperty('middleName'))
        obj.middleName = ApiClient.convertToType(data['middleName'], [SourceName]);
      if (data.hasOwnProperty('phoneNumbers'))
        obj.phoneNumbers = ApiClient.convertToType(data['phoneNumbers'], [SourceName]);
      if (data.hasOwnProperty('physicalAddresses'))
        obj.physicalAddresses = ApiClient.convertToType(data['physicalAddresses'], [SourceName]);
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/SourceName>} emailAddresses
   */
   ...
   * @member {Array.<module:model/SourceName>} phoneNumbers
   */
   ...
   * @member {Array.<module:model/SourceName>} physicalAddresses
   */
