...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BasiqApi.JobsResult = factory(root.BasiqApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The JobsResult model module.
   * @module model/JobsResult
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>JobsResult</code>.
   * Result object containing a list of URLs or null. Otherwise if a step failed contains an error response.
   * @alias module:model/JobsResult
   * @class
   */
  ...
  /**
   * Constructs a <code>JobsResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/JobsResult} obj Optional instance to populate.
   * @return {module:model/JobsResult} The populated <code>JobsResult</code> instance.
   */
   ...
   * @member {module:model/JobsResult.CodeEnum} code
   */
  ...
  exports.CodeEnum = {
    ...
    /**
     * value: "institution-not-available"
     * @const
     */
    institutionNotAvailable: "institution-not-available",

    /**
     * value: "institution-disabled"
     * @const
     */
    institutionDisabled: "institution-disabled",
     ...
     * @const
     */
    missingRequiredFieldValue: "missing-required-field-value",
    ...
    /**
     * value: "invalid-csv-row"
     * @const
     */
    invalidCsvRow: "invalid-csv-row",

    /**
     * value: "row-count-exceeded"
     * @const
     */
    rowCountExceeded: "row-count-exceeded",

    /**
     * value: "account-data-differs"
     * @const
     */
    accountDataDiffers: "account-data-differs",
    ...
    /**
     * value: "bank-statement-invalid"
     * @const
     */
    bankStatementInvalid: "bank-statement-invalid",

    /**
     * value: "bank-statement-new-product"
     * @const
     */
    bankStatementNewProduct: "bank-statement-new-product",

    /**
     * value: "bank-statement-parsing-error"
     * @const
     */
    bankStatementParsingError: "bank-statement-parsing-error",

    /**
     * value: "bank-statement-not-supported"
     * @const
     */
    bankStatementNotSupported: "bank-statement-not-supported",

    /**
     * value: "txn-after-last-updated-date"
     * @const
     */
    txnAfterLastUpdatedDate: "txn-after-last-updated-date",
