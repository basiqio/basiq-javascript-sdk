...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ConnectionInstitution', 'model/GetConnectionsLinks'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ConnectionInstitution'), require('./GetConnectionsLinks'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.ConnectionsData = factory(root.BasiqApi.ApiClient, root.BasiqApi.ConnectionInstitution, root.BasiqApi.GetConnectionsLinks);
  }
}(this, function(ApiClient, ConnectionInstitution, GetConnectionsLinks) {
  'use strict';

  /**
   * The ConnectionsData model module.
   * @module model/ConnectionsData
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>ConnectionsData</code>.
   * @alias module:model/ConnectionsData
   * @class
   * @param createdDate {String} Created date of the connection, available only for SERVER_SCOPE.
   * @param id {String} Connection identification.
   * @param institution {module:model/ConnectionInstitution} 
   * @param links {module:model/GetConnectionsLinks} 
   * @param type {String} Type, always \"connection\".
   */
  var exports = function(createdDate, id, institution, links, type) {
  ...
  /**
   * Constructs a <code>ConnectionsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ConnectionsData} obj Optional instance to populate.
   * @return {module:model/ConnectionsData} The populated <code>ConnectionsData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('links'))
        obj.links = GetConnectionsLinks.constructFromObject(data['links']);
  ...
  /**
   * @member {module:model/GetConnectionsLinks} links
   */
  exports.prototype.links = undefined;

  /**
   * Connection status, available only for SERVER_SCOPE.
   * @member {module:model/ConnectionsData.StatusEnum} status
   */
