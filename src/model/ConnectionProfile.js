...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PhysicalAddresses'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PhysicalAddresses'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.ConnectionProfile = factory(root.BasiqApi.ApiClient, root.BasiqApi.PhysicalAddresses);
  }
}(this, function(ApiClient, PhysicalAddresses) {
  'use strict';
   ...
   * @class
   * @param emailAddresses {Array.<String>} User email address
   * @param firstName {String} User first name
   * @param fullName {String} User full name
   * @param lastName {String} User last name
   * @param middleName {String} User middle name
   * @param phoneNumbers {Array.<String>} User phone number
   * @param physicalAddresses {Array.<module:model/PhysicalAddresses>} Physical user addresses
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('physicalAddresses'))
        obj.physicalAddresses = ApiClient.convertToType(data['physicalAddresses'], [PhysicalAddresses]);
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/PhysicalAddresses>} physicalAddresses
   */
