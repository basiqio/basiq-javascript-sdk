...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AffordabilityRegularIncomeData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AffordabilityRegularIncomeData'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.AffordabilitySummary = factory(root.BasiqApi.ApiClient, root.BasiqApi.AffordabilityRegularIncomeData);
  }
}(this, function(ApiClient, AffordabilityRegularIncomeData) {
  'use strict';

  /**
   * The AffordabilitySummary model module.
   * @module model/AffordabilitySummary
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>AffordabilitySummary</code>.
   * @alias module:model/AffordabilitySummary
   * @class
   * @param assets {String} Total of cash based assets
   * @param creditLimit {String} Total credit limit across all credit cards and overdrafts
   * @param expenses {String} Provides an average of monthly expenses calculated for the whole period of data retrieved (e.g. 13 months)
   * @param liabilities {String} Total of account based liabilities split into credit and loan liabilities
   * @param loanRepaymentMonthly {String} Total of all repayments monthly to disclosed loan liabilities as an average monthly amount
   * @param netPosition {String} Total assets minus total liabilities
   * @param potentialLiabilitiesMonthly {String} Total of all repayments monthly to potential undisclosed loan liabilities as an average monthly amount
   * @param regularIncome {module:model/AffordabilityRegularIncomeData} 
   * @param savings {String} Average of monthly savings calculated for the whole period of data retrieved (e.g. 13 months)
   */
  var exports = function(assets, creditLimit, expenses, liabilities, loanRepaymentMonthly, netPosition, potentialLiabilitiesMonthly, regularIncome, savings) {
    this.assets = assets;
    this.creditLimit = creditLimit;
    this.expenses = expenses;
    this.liabilities = liabilities;
    this.loanRepaymentMonthly = loanRepaymentMonthly;
    this.netPosition = netPosition;
    this.potentialLiabilitiesMonthly = potentialLiabilitiesMonthly;
    this.regularIncome = regularIncome;
    this.savings = savings;
  };

  /**
   * Constructs a <code>AffordabilitySummary</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AffordabilitySummary} obj Optional instance to populate.
   * @return {module:model/AffordabilitySummary} The populated <code>AffordabilitySummary</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('loanRepaymentMonthly'))
        obj.loanRepaymentMonthly = ApiClient.convertToType(data['loanRepaymentMonthly'], 'String');
      if (data.hasOwnProperty('netPosition'))
        obj.netPosition = ApiClient.convertToType(data['netPosition'], 'String');
      if (data.hasOwnProperty('potentialLiabilitiesMonthly'))
        obj.potentialLiabilitiesMonthly = ApiClient.convertToType(data['potentialLiabilitiesMonthly'], 'String');
      if (data.hasOwnProperty('regularIncome'))
        obj.regularIncome = AffordabilityRegularIncomeData.constructFromObject(data['regularIncome']);
      if (data.hasOwnProperty('savings'))
        obj.savings = ApiClient.convertToType(data['savings'], 'String');
    }
    return obj;
  }
   ...
   * @member {String} loanRepaymentMonthly
   */
  exports.prototype.loanRepaymentMonthly = undefined;

  /**
   * Total assets minus total liabilities
   * @member {String} netPosition
   */
  exports.prototype.netPosition = undefined;

  /**
   * Total of all repayments monthly to potential undisclosed loan liabilities as an average monthly amount
   * @member {String} potentialLiabilitiesMonthly
   */
  exports.prototype.potentialLiabilitiesMonthly = undefined;

  /**
   * @member {module:model/AffordabilityRegularIncomeData} regularIncome
   */
  exports.prototype.regularIncome = undefined;

  /**
   * Average of monthly savings calculated for the whole period of data retrieved (e.g. 13 months)
   * @member {String} savings
   */
