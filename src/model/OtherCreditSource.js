...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ChangeHistoryIncome', 'model/CurrentOtherCreditSource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ChangeHistoryIncome'), require('./CurrentOtherCreditSource'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.OtherCreditSource = factory(root.BasiqApi.ApiClient, root.BasiqApi.ChangeHistoryIncome, root.BasiqApi.CurrentOtherCreditSource);
  }
}(this, function(ApiClient, ChangeHistoryIncome, CurrentOtherCreditSource) {
  'use strict';

  /**
   * The OtherCreditSource model module.
   * @module model/OtherCreditSource
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>OtherCreditSource</code>.
   ...
   * @alias module:model/OtherCreditSource
   * @class
   * @param ageDays {Number} Duration other income (number days from first to last occurrence) returned as an integer with values zero or greater.
   * @param amountAvg {String} Mean of irregular income amount - calculated across all occurrences identified.
   * @param avgMonthlyOccurence {String} Average (mean) number of times per calendar month the credits in the series occur.
   * @param changeHistory {Array.<module:model/ChangeHistoryIncome>} Each amount classified as income (repeated for each income credit and ordered by most recent)
   * @param current {module:model/CurrentOtherCreditSource} 
   * @param frequency {module:model/OtherCreditSource.FrequencyEnum} Frequency is \"other\", \"irregular\" or a time period e.g. \"bi-weekly\"
   * @param noOccurrences {Number} Number of instances of credits in the series.
   * @param source {String} Source Other Credit income (cleaned transaction description).
   */
  var exports = function(ageDays, amountAvg, avgMonthlyOccurence, changeHistory, current, frequency, noOccurrences, source) {
    this.ageDays = ageDays;
    this.amountAvg = amountAvg;
    this.avgMonthlyOccurence = avgMonthlyOccurence;
  ...
  /**
   * Constructs a <code>OtherCreditSource</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OtherCreditSource} obj Optional instance to populate.
   * @return {module:model/OtherCreditSource} The populated <code>OtherCreditSource</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('amountAvg'))
        obj.amountAvg = ApiClient.convertToType(data['amountAvg'], 'String');
      if (data.hasOwnProperty('avgMonthlyOccurence'))
        obj.avgMonthlyOccurence = ApiClient.convertToType(data['avgMonthlyOccurence'], 'String');
      if (data.hasOwnProperty('changeHistory'))
        obj.changeHistory = ApiClient.convertToType(data['changeHistory'], [ChangeHistoryIncome]);
      if (data.hasOwnProperty('current'))
        obj.current = CurrentOtherCreditSource.constructFromObject(data['current']);
      if (data.hasOwnProperty('frequency'))
        obj.frequency = ApiClient.convertToType(data['frequency'], 'String');
      if (data.hasOwnProperty('noOccurrences'))
        obj.noOccurrences = ApiClient.convertToType(data['noOccurrences'], 'Number');
   ...
   */
  exports.prototype.ageDays = undefined;

  /**
   * Mean of irregular income amount - calculated across all occurrences identified.
   * @member {String} amountAvg
   */
  exports.prototype.amountAvg = undefined;

  /**
   * Average (mean) number of times per calendar month the credits in the series occur.
   * @member {String} avgMonthlyOccurence
   */
  exports.prototype.avgMonthlyOccurence = undefined;

  /**
   * Each amount classified as income (repeated for each income credit and ordered by most recent)
   * @member {Array.<module:model/ChangeHistoryIncome>} changeHistory
   */
  exports.prototype.changeHistory = undefined;

  /**
   * @member {module:model/CurrentOtherCreditSource} current
   */
  exports.prototype.current = undefined;

  /**
   * Frequency is \"other\", \"irregular\" or a time period e.g. \"bi-weekly\"
   * @member {module:model/OtherCreditSource.FrequencyEnum} frequency
   */
  exports.prototype.frequency = undefined;

  /**
   * Number of instances of credits in the series.
   * @member {Number} noOccurrences
   */
  exports.prototype.noOccurrences = undefined;
