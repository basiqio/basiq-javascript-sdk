...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BasiqApi.ExternalPayment = factory(root.BasiqApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ExternalPayment model module.
   * @module model/ExternalPayment
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>ExternalPayment</code>.
   * @alias module:model/ExternalPayment
   * @class
   * @param amountAvg {String} Number of occurrences for same source (in this group)
   * @param amountAvgMonthly {String} Average monthly payment amount
   * @param first {Date} Date of first payment
   * @param last {Date} Date of last payment
   * @param noOccurrences {Number} Number of occurrences for same source (in this group)
   * @param total {String} Amount of total payments identified for source in the affordability snapshot
   */
  var exports = function(amountAvg, amountAvgMonthly, first, last, noOccurrences, total) {
    this.amountAvg = amountAvg;
    this.amountAvgMonthly = amountAvgMonthly;
    this.first = first;
    this.last = last;
  ...
  /**
   * Constructs a <code>ExternalPayment</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ExternalPayment} obj Optional instance to populate.
   * @return {module:model/ExternalPayment} The populated <code>ExternalPayment</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('amountAvgMonthly'))
        obj.amountAvgMonthly = ApiClient.convertToType(data['amountAvgMonthly'], 'String');
      if (data.hasOwnProperty('first'))
        obj.first = ApiClient.convertToType(data['first'], 'Date');
   ...
   * @member {String} amountAvgMonthly
   */
  exports.prototype.amountAvgMonthly = undefined;
