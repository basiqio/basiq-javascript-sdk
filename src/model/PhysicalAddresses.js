...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BasiqApi.PhysicalAddresses = factory(root.BasiqApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PhysicalAddresses model module.
   * @module model/PhysicalAddresses
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>PhysicalAddresses</code>.
   * User physical addresses holding the connection.
   * @alias module:model/PhysicalAddresses
   * @class
   * @param addressLine1 {String} User address.
   * @param addressLine2 {String} Always \"null\"
   * @param addressLine3 {String} Always \"null\"
   * @param city {String} City
   * @param countryCode {String} Country code
   * @param formattedAddress {String} Address formatted.
   * @param postcode {String} Post code
   * @param state {String} State
   */
  var exports = function(addressLine1, addressLine2, addressLine3, city, countryCode, formattedAddress, postcode, state) {
  ...
  /**
   * Constructs a <code>PhysicalAddresses</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PhysicalAddresses} obj Optional instance to populate.
   * @return {module:model/PhysicalAddresses} The populated <code>PhysicalAddresses</code> instance.
   */
