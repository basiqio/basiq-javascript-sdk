...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BasiqApi.ChangeHistoryAffordabilityData = factory(root.BasiqApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ChangeHistoryAffordabilityData model module.
   * @module model/ChangeHistoryAffordabilityData
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>ChangeHistoryAffordabilityData</code>.
   * @alias module:model/ChangeHistoryAffordabilityData
   * @class
   * @param amount {String} Amount loan-interest or loan-repayment
   * @param _date {Date} Date
   * @param direction {module:model/ChangeHistoryAffordabilityData.DirectionEnum} Debit or Credit
   * @param source {String} Cleaned transaction description
   */
  var exports = function(amount, _date, direction, source) {
    this.amount = amount;
    this._date = _date;
  ...
  /**
   * Constructs a <code>ChangeHistoryAffordabilityData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ChangeHistoryAffordabilityData} obj Optional instance to populate.
   * @return {module:model/ChangeHistoryAffordabilityData} The populated <code>ChangeHistoryAffordabilityData</code> instance.
   */
  ...
  /**
   * Debit or Credit
   * @member {module:model/ChangeHistoryAffordabilityData.DirectionEnum} direction
   */
