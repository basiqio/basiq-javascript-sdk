...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccountsContainer', 'model/ConnectionInstitution', 'model/ConnectionProfile', 'model/GetConnectionLinks'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AccountsContainer'), require('./ConnectionInstitution'), require('./ConnectionProfile'), require('./GetConnectionLinks'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.ConnectionGetResponseResource = factory(root.BasiqApi.ApiClient, root.BasiqApi.AccountsContainer, root.BasiqApi.ConnectionInstitution, root.BasiqApi.ConnectionProfile, root.BasiqApi.GetConnectionLinks);
  }
}(this, function(ApiClient, AccountsContainer, ConnectionInstitution, ConnectionProfile, GetConnectionLinks) {
  'use strict';

  /**
   * The ConnectionGetResponseResource model module.
   * @module model/ConnectionGetResponseResource
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>ConnectionGetResponseResource</code>.
   * Object containing details for connection post.
   * @alias module:model/ConnectionGetResponseResource
   * @class
   * @param id {String} A string that uniquely identifies the user connection.
   * @param institution {module:model/ConnectionInstitution} 
   * @param createdDate {String} Created date of the connection, available only for SERVER_SCOPE.
   * @param links {module:model/GetConnectionLinks} 
   * @param type {String} Type, always \"connection\".
   */
  var exports = function(id, institution, createdDate, links, type) {
    this.id = id;
  ...
  /**
   * Constructs a <code>ConnectionGetResponseResource</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ConnectionGetResponseResource} obj Optional instance to populate.
   * @return {module:model/ConnectionGetResponseResource} The populated <code>ConnectionGetResponseResource</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('accounts'))
        obj.accounts = AccountsContainer.constructFromObject(data['accounts']);
      if (data.hasOwnProperty('id'))
        obj.id = ApiClient.convertToType(data['id'], 'String');
      if (data.hasOwnProperty('institution'))
        obj.institution = ConnectionInstitution.constructFromObject(data['institution']);
      if (data.hasOwnProperty('createdDate'))
        obj.createdDate = ApiClient.convertToType(data['createdDate'], 'String');
      if (data.hasOwnProperty('lastUsed'))
        obj.lastUsed = ApiClient.convertToType(data['lastUsed'], 'String');
      if (data.hasOwnProperty('links'))
        obj.links = GetConnectionLinks.constructFromObject(data['links']);
      if (data.hasOwnProperty('profile'))
        obj.profile = ConnectionProfile.constructFromObject(data['profile']);
  ...
  /**
   * @member {module:model/AccountsContainer} accounts
   */
  ...
  /**
   * @member {module:model/ConnectionInstitution} institution
   */
  ...
  /**
   * @member {module:model/GetConnectionLinks} links
   */
  exports.prototype.links = undefined;

  /**
   * @member {module:model/ConnectionProfile} profile
   */
  exports.prototype.profile = undefined;

  /**
   * Indicates the connection status, available only for SERVER_SCOPE. Possible values include: <ul> <li>pending - the connection is in this status briefly until credentials are verified</li> <li>active - the connection is valid (is working!) and the credentials have been verified (the jobs steps will continue) </li> <li>invalid -  the connection is no longer valid and requires the user to update their logon details. Invalid connections cannot refreshed until the password is updated. </li> </ul>
   * @member {module:model/ConnectionGetResponseResource.StatusEnum} status
   */
