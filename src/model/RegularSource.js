...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ChangeHistoryIncome', 'model/CurrentRegularSource', 'model/IrregularityIncome', 'model/Previous3MonthsIncome'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ChangeHistoryIncome'), require('./CurrentRegularSource'), require('./IrregularityIncome'), require('./Previous3MonthsIncome'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.RegularSource = factory(root.BasiqApi.ApiClient, root.BasiqApi.ChangeHistoryIncome, root.BasiqApi.CurrentRegularSource, root.BasiqApi.IrregularityIncome, root.BasiqApi.Previous3MonthsIncome);
  }
}(this, function(ApiClient, ChangeHistoryIncome, CurrentRegularSource, IrregularityIncome, Previous3MonthsIncome) {
  'use strict';

  /**
   * The RegularSource model module.
   * @module model/RegularSource
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>RegularSource</code>.
   * @alias module:model/RegularSource
   * @class
   * @param ageDays {Number} Duration regular income (number days from first to last occurrence) returned as an integer with values zero or greater
   ...
   * @param current {module:model/CurrentRegularSource} 
   * @param frequency {module:model/RegularSource.FrequencyEnum} Enum detailing frequency regular income
   * @param irregularity {module:model/IrregularityIncome} 
   * @param previous3Months {module:model/Previous3MonthsIncome} 
   * @param source {String} Source regular income (cleaned transaction description).
   */
  var exports = function(ageDays, changeHistory, current, frequency, irregularity, previous3Months, source) {
  ...
  /**
   * Constructs a <code>RegularSource</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RegularSource} obj Optional instance to populate.
   * @return {module:model/RegularSource} The populated <code>RegularSource</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('current'))
        obj.current = CurrentRegularSource.constructFromObject(data['current']);
      if (data.hasOwnProperty('frequency'))
        obj.frequency = ApiClient.convertToType(data['frequency'], 'String');
      if (data.hasOwnProperty('irregularity'))
        obj.irregularity = IrregularityIncome.constructFromObject(data['irregularity']);
      if (data.hasOwnProperty('previous3Months'))
        obj.previous3Months = Previous3MonthsIncome.constructFromObject(data['previous3Months']);
  ...
  /**
   * @member {module:model/CurrentRegularSource} current
   */
  exports.prototype.current = undefined;

  /**
   * Enum detailing frequency regular income
   * @member {module:model/RegularSource.FrequencyEnum} frequency
   */
  exports.prototype.frequency = undefined;

  /**
   * @member {module:model/IrregularityIncome} irregularity
   */
  exports.prototype.irregularity = undefined;

  /**
   * @member {module:model/Previous3MonthsIncome} previous3Months
   */
  exports.prototype.previous3Months = undefined;
