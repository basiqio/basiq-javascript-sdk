...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AffordabilityAssetsData', 'model/AffordabilitySummary', 'model/ExternalLiabilityData', 'model/GetAffordabilityLinks', 'model/LiabilitiesData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AffordabilityAssetsData'), require('./AffordabilitySummary'), require('./ExternalLiabilityData'), require('./GetAffordabilityLinks'), require('./LiabilitiesData'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.AffordabilityResponse = factory(root.BasiqApi.ApiClient, root.BasiqApi.AffordabilityAssetsData, root.BasiqApi.AffordabilitySummary, root.BasiqApi.ExternalLiabilityData, root.BasiqApi.GetAffordabilityLinks, root.BasiqApi.LiabilitiesData);
  }
}(this, function(ApiClient, AffordabilityAssetsData, AffordabilitySummary, ExternalLiabilityData, GetAffordabilityLinks, LiabilitiesData) {
  'use strict';

  /**
   * The AffordabilityResponse model module.
   * @module model/AffordabilityResponse
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>AffordabilityResponse</code>.
   * Container object, containing affordability details.  The affordability object includes a summary of financial position, assets, liabilities, with links to an income object and an expenses object, for an individual user for account and transaction data stored against that user.
   * @alias module:model/AffordabilityResponse
   * @class
   * @param assets {Array.<module:model/AffordabilityAssetsData>} Assets
   * @param external {Array.<module:model/ExternalLiabilityData>} External
   * @param fromMonth {String} Start month for the period for which the Affordability summary is generated. The period of time relates to the account and transaction data used as input into the report.
   * @param generatedDate {String} Date the report was generated.
   * @param id {String} Uniquely identifies the affordability report.
   * @param liabilities {module:model/LiabilitiesData} 
   * @param links {module:model/GetAffordabilityLinks} 
   * @param summary {module:model/AffordabilitySummary} 
   * @param toMonth {String} End month (usually the current month) for the period for which the Affordability summary is generated.
   * @param type {String} Always \"affordability\".
   */
  var exports = function(assets, external, fromMonth, generatedDate, id, liabilities, links, summary, toMonth, type) {
    this.assets = assets;
  ...
  /**
   * Constructs a <code>AffordabilityResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AffordabilityResponse} obj Optional instance to populate.
   * @return {module:model/AffordabilityResponse} The populated <code>AffordabilityResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('assets'))
        obj.assets = ApiClient.convertToType(data['assets'], [AffordabilityAssetsData]);
      ...
      if (data.hasOwnProperty('external'))
        obj.external = ApiClient.convertToType(data['external'], [ExternalLiabilityData]);
      ...
      if (data.hasOwnProperty('generatedDate'))
        obj.generatedDate = ApiClient.convertToType(data['generatedDate'], 'String');
      if (data.hasOwnProperty('id'))
        obj.id = ApiClient.convertToType(data['id'], 'String');
      if (data.hasOwnProperty('liabilities'))
        obj.liabilities = LiabilitiesData.constructFromObject(data['liabilities']);
      if (data.hasOwnProperty('links'))
        obj.links = GetAffordabilityLinks.constructFromObject(data['links']);
      if (data.hasOwnProperty('summary'))
        obj.summary = AffordabilitySummary.constructFromObject(data['summary']);
  ...
  /**
   * Assets
   * @member {Array.<module:model/AffordabilityAssetsData>} assets
   */
  ...
  /**
   * External
   * @member {Array.<module:model/ExternalLiabilityData>} external
   */
   ...
   * @member {String} generatedDate
   */
  exports.prototype.generatedDate = undefined;
  ...
  /**
   * @member {module:model/LiabilitiesData} liabilities
   */
  exports.prototype.liabilities = undefined;

  /**
   * @member {module:model/GetAffordabilityLinks} links
   */
  exports.prototype.links = undefined;

  /**
   * @member {module:model/AffordabilitySummary} summary
   */
