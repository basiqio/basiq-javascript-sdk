...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccountHolder', 'model/Previous6MonthsCreditLiabilities', 'model/PreviousMonthDataLiabilities'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AccountHolder'), require('./Previous6MonthsCreditLiabilities'), require('./PreviousMonthDataLiabilities'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.CreditLiabilities = factory(root.BasiqApi.ApiClient, root.BasiqApi.AccountHolder, root.BasiqApi.Previous6MonthsCreditLiabilities, root.BasiqApi.PreviousMonthDataLiabilities);
  }
}(this, function(ApiClient, AccountHolder, Previous6MonthsCreditLiabilities, PreviousMonthDataLiabilities) {
  'use strict';

  /**
   * The CreditLiabilities model module.
   * @module model/CreditLiabilities
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>CreditLiabilities</code>.
   * @alias module:model/CreditLiabilities
   * @class
   ...
   * @param creditLimit {String} Total credit limit available for the specified credit facility.
   ...
   * @param previous6Months {module:model/Previous6MonthsCreditLiabilities} 
   * @param previousMonth {module:model/PreviousMonthDataLiabilities} 
   */
  var exports = function(account, availableFunds, balance, creditLimit, currency, institution, previous6Months, previousMonth) {
  ...
  /**
   * Constructs a <code>CreditLiabilities</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreditLiabilities} obj Optional instance to populate.
   * @return {module:model/CreditLiabilities} The populated <code>CreditLiabilities</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('previous6Months'))
        obj.previous6Months = Previous6MonthsCreditLiabilities.constructFromObject(data['previous6Months']);
      if (data.hasOwnProperty('previousMonth'))
        obj.previousMonth = PreviousMonthDataLiabilities.constructFromObject(data['previousMonth']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/Previous6MonthsCreditLiabilities} previous6Months
   */
  exports.prototype.previous6Months = undefined;

  /**
   * @member {module:model/PreviousMonthDataLiabilities} previousMonth
   */
