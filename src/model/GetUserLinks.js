...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BasiqApi.GetUserLinks = factory(root.BasiqApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The GetUserLinks model module.
   * @module model/GetUserLinks
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>GetUserLinks</code>.
   * Object containing links to resources.
   * @alias module:model/GetUserLinks
   * @class
   * @param accounts {String} Accounts reference url.
   * @param authLink {String} Auth link, possible null.
   * @param connections {String} Connections reference url.
   * @param self {String} User self reference url.
   * @param transactions {String} Transactions reference url.
   */
  var exports = function(accounts, authLink, connections, self, transactions) {
  ...
  /**
   * Constructs a <code>GetUserLinks</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetUserLinks} obj Optional instance to populate.
   * @return {module:model/GetUserLinks} The populated <code>GetUserLinks</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('auth_link'))
        obj.authLink = ApiClient.convertToType(data['auth_link'], 'String');
   ...
   * @member {String} authLink
   */
  exports.prototype.authLink = undefined;
