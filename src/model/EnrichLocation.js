...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EnrichGeometry'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EnrichGeometry'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.EnrichLocation = factory(root.BasiqApi.ApiClient, root.BasiqApi.EnrichGeometry);
  }
}(this, function(ApiClient, EnrichGeometry) {
  'use strict';

  /**
   * The EnrichLocation model module.
   * @module model/EnrichLocation
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>EnrichLocation</code>.
   * @alias module:model/EnrichLocation
   * @class
   */
  ...
  /**
   * Constructs a <code>EnrichLocation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EnrichLocation} obj Optional instance to populate.
   * @return {module:model/EnrichLocation} The populated <code>EnrichLocation</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('geometry'))
        obj.geometry = EnrichGeometry.constructFromObject(data['geometry']);
  ...
  /**
   * @member {module:model/EnrichGeometry} geometry
   */
