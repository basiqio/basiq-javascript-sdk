...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/IncomeLinks', 'model/IncomeSummary', 'model/IrregularSource', 'model/OtherCreditSource', 'model/RegularSource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./IncomeLinks'), require('./IncomeSummary'), require('./IrregularSource'), require('./OtherCreditSource'), require('./RegularSource'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.IncomeResponse = factory(root.BasiqApi.ApiClient, root.BasiqApi.IncomeLinks, root.BasiqApi.IncomeSummary, root.BasiqApi.IrregularSource, root.BasiqApi.OtherCreditSource, root.BasiqApi.RegularSource);
  }
}(this, function(ApiClient, IncomeLinks, IncomeSummary, IrregularSource, OtherCreditSource, RegularSource) {
  'use strict';

  /**
   * The IncomeResponse model module.
   * @module model/IncomeResponse
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>IncomeResponse</code>.
   * Container object, containing income details.  The Income Summary object with income summarised and classified by type: regular, irregular or other sources (created/refreshed across up to 10 institutions)
   * @alias module:model/IncomeResponse
   * @class
   * @param fromMonth {String} Start month for the period for which the Income summary is generated. The period of time relates to the account and transaction data used as input into the report.
   * @param id {String} The identifier of the income resource to be retrieved.
   * @param summary {module:model/IncomeSummary} 
   * @param toMonth {String} End month (usually the current month) for the period for which the Income summary is generated.
   * @param type {String} Always \"income\".
   */
  var exports = function(fromMonth, id, summary, toMonth, type) {
  ...
  /**
   * Constructs a <code>IncomeResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IncomeResponse} obj Optional instance to populate.
   * @return {module:model/IncomeResponse} The populated <code>IncomeResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('irregular'))
        obj.irregular = ApiClient.convertToType(data['irregular'], [IrregularSource]);
      if (data.hasOwnProperty('links'))
        obj.links = IncomeLinks.constructFromObject(data['links']);
      if (data.hasOwnProperty('otherCredit'))
        obj.otherCredit = ApiClient.convertToType(data['otherCredit'], [OtherCreditSource]);
      if (data.hasOwnProperty('regular'))
        obj.regular = ApiClient.convertToType(data['regular'], [RegularSource]);
      if (data.hasOwnProperty('summary'))
        obj.summary = IncomeSummary.constructFromObject(data['summary']);
  ...
  /**
   * Required true
   * @member {Array.<module:model/IrregularSource>} irregular
   */
  exports.prototype.irregular = undefined;

  /**
   * @member {module:model/IncomeLinks} links
   */
  exports.prototype.links = undefined;

  /**
   * Required true
   * @member {Array.<module:model/OtherCreditSource>} otherCredit
   */
  exports.prototype.otherCredit = undefined;

  /**
   * Required true
   * @member {Array.<module:model/RegularSource>} regular
   */
  exports.prototype.regular = undefined;

  /**
   * @member {module:model/IncomeSummary} summary
   */
