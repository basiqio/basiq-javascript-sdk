...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TransactionsGeometry'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TransactionsGeometry'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.TransactionsLocation = factory(root.BasiqApi.ApiClient, root.BasiqApi.TransactionsGeometry);
  }
}(this, function(ApiClient, TransactionsGeometry) {
  'use strict';

  /**
   * The TransactionsLocation model module.
   * @module model/TransactionsLocation
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>TransactionsLocation</code>.
   * @alias module:model/TransactionsLocation
   * @class
   */
  ...
  /**
   * Constructs a <code>TransactionsLocation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransactionsLocation} obj Optional instance to populate.
   * @return {module:model/TransactionsLocation} The populated <code>TransactionsLocation</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('geometry'))
        obj.geometry = TransactionsGeometry.constructFromObject(data['geometry']);
      if (data.hasOwnProperty('postalCode'))
        obj.postalCode = ApiClient.convertToType(data['postalCode'], 'String');
      if (data.hasOwnProperty('route'))
        obj.route = ApiClient.convertToType(data['route'], 'String');
      if (data.hasOwnProperty('routeNo'))
        obj.routeNo = ApiClient.convertToType(data['routeNo'], 'String');
  ...
  /**
   * @member {module:model/TransactionsGeometry} geometry
   */
  ...
  /**
   * Route Number
   * @member {String} routeNo
   */
  exports.prototype.routeNo = undefined;
