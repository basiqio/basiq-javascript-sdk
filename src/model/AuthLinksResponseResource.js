...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AuthLinkLinks'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AuthLinkLinks'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.AuthLinksResponseResource = factory(root.BasiqApi.ApiClient, root.BasiqApi.AuthLinkLinks);
  }
}(this, function(ApiClient, AuthLinkLinks) {
  'use strict';

  /**
   * The AuthLinksResponseResource model module.
   * @module model/AuthLinksResponseResource
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>AuthLinksResponseResource</code>.
   * @alias module:model/AuthLinksResponseResource
   * @class
   * @param expiresAt {String} The date time of auth link expiry.
   * @param id {String} Uniquely identifies the auth link.
   * @param mobile {String} A user's mobile phone, used as for authentication.
   * @param type {String} Type of the response, always \"auth_link\".
   * @param userId {String} A string that uniquely identifies the user.
   */
  var exports = function(expiresAt, id, mobile, type, userId) {
  ...
  /**
   * Constructs a <code>AuthLinksResponseResource</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AuthLinksResponseResource} obj Optional instance to populate.
   * @return {module:model/AuthLinksResponseResource} The populated <code>AuthLinksResponseResource</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('links'))
        obj.links = AuthLinkLinks.constructFromObject(data['links']);
  ...
  /**
   * @member {module:model/AuthLinkLinks} links
   */
