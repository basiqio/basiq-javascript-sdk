...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ChangeHistoryIncome', 'model/CurrentIrregularSource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ChangeHistoryIncome'), require('./CurrentIrregularSource'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.IrregularSource = factory(root.BasiqApi.ApiClient, root.BasiqApi.ChangeHistoryIncome, root.BasiqApi.CurrentIrregularSource);
  }
}(this, function(ApiClient, ChangeHistoryIncome, CurrentIrregularSource) {
  'use strict';

  /**
   * The IrregularSource model module.
   * @module model/IrregularSource
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>IrregularSource</code>.
   * Irregular Income sources typically require at least 5 credits across a minimum 90 day time period
   * @alias module:model/IrregularSource
   * @class
   * @param ageDays {Number} Duration irregular income (number days from first to last occurrence) returned as an integer with values zero or greater.
   ...
   * @param current {module:model/CurrentIrregularSource} 
   * @param frequency {String} Frequency is \"irregular\"
   * @param noOccurrences {Number} Number of instances of credits in the series.
   * @param source {String} Source irregular income (cleaned transaction description).
   */
  ...
  /**
   * Constructs a <code>IrregularSource</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IrregularSource} obj Optional instance to populate.
   * @return {module:model/IrregularSource} The populated <code>IrregularSource</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('current'))
        obj.current = CurrentIrregularSource.constructFromObject(data['current']);
  ...
  /**
   * @member {module:model/CurrentIrregularSource} current
   */
