...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/JobsInstitution', 'model/JobsLinks', 'model/JobsStep'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./JobsInstitution'), require('./JobsLinks'), require('./JobsStep'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.JobsData = factory(root.BasiqApi.ApiClient, root.BasiqApi.JobsInstitution, root.BasiqApi.JobsLinks, root.BasiqApi.JobsStep);
  }
}(this, function(ApiClient, JobsInstitution, JobsLinks, JobsStep) {
  'use strict';
   ...
   * @class
   * @param created {String} The date time when the job was created.
   * @param id {String} A string that uniquely identifies the job.
   * @param institution {module:model/JobsInstitution} 
   * @param steps {Array.<module:model/JobsStep>} List of steps that need to be completed.
   * @param updated {String} The date time when the job was last updated.
   */
  var exports = function(created, id, institution, steps, updated) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('institution'))
        obj.institution = JobsInstitution.constructFromObject(data['institution']);
      if (data.hasOwnProperty('links'))
        obj.links = JobsLinks.constructFromObject(data['links']);
      if (data.hasOwnProperty('steps'))
        obj.steps = ApiClient.convertToType(data['steps'], [JobsStep]);
  ...
  /**
   * @member {module:model/JobsInstitution} institution
   */
  exports.prototype.institution = undefined;

  /**
   * @member {module:model/JobsLinks} links
   */
  exports.prototype.links = undefined;

  /**
   * List of steps that need to be completed.
   * @member {Array.<module:model/JobsStep>} steps
   */
