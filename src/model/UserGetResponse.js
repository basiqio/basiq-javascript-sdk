...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetUserAccount', 'model/GetUserConnection', 'model/GetUserLinks'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetUserAccount'), require('./GetUserConnection'), require('./GetUserLinks'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.UserGetResponse = factory(root.BasiqApi.ApiClient, root.BasiqApi.GetUserAccount, root.BasiqApi.GetUserConnection, root.BasiqApi.GetUserLinks);
  }
}(this, function(ApiClient, GetUserAccount, GetUserConnection, GetUserLinks) {
  'use strict';
   ...
   * @class
   * @param accounts {module:model/GetUserAccount} 
   * @param connections {module:model/GetUserConnection} 
   * @param email {String} User email or empty.
   * @param id {String} User identification.
   * @param links {module:model/GetUserLinks} 
   * @param mobile {String} User mobile number, or empty.
   * @param name {String} Name, or empty.
   * @param type {String} Always \"user\".
   */
  var exports = function(accounts, connections, email, id, links, mobile, name, type) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('accounts'))
        obj.accounts = GetUserAccount.constructFromObject(data['accounts']);
      if (data.hasOwnProperty('business'))
        obj.business = ApiClient.convertToType(data['business'], 'String');
      if (data.hasOwnProperty('connections'))
        obj.connections = GetUserConnection.constructFromObject(data['connections']);
      if (data.hasOwnProperty('email'))
        obj.email = ApiClient.convertToType(data['email'], 'String');
      if (data.hasOwnProperty('id'))
        obj.id = ApiClient.convertToType(data['id'], 'String');
      if (data.hasOwnProperty('links'))
        obj.links = GetUserLinks.constructFromObject(data['links']);
  ...
  /**
   * @member {module:model/GetUserAccount} accounts
   */
  exports.prototype.accounts = undefined;

  /**
   * Business is ignored - it is populated when user has BusinessNumber or BusinessName swagger: ignore
   * @member {String} business
   */
  exports.prototype.business = undefined;

  /**
   * @member {module:model/GetUserConnection} connections
   */
  ...
  /**
   * @member {module:model/GetUserLinks} links
   */
