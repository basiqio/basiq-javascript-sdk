...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AffordabilityTransactionLinks', 'model/SubClass'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AffordabilityTransactionLinks'), require('./SubClass'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.TransactionDataAffordability = factory(root.BasiqApi.ApiClient, root.BasiqApi.AffordabilityTransactionLinks, root.BasiqApi.SubClass);
  }
}(this, function(ApiClient, AffordabilityTransactionLinks, SubClass) {
  'use strict';

  /**
   * The TransactionDataAffordability model module.
   * @module model/TransactionDataAffordability
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>TransactionDataAffordability</code>.
   * @alias module:model/TransactionDataAffordability
   * @class
   ...
   * @param _class {module:model/TransactionDataAffordability.ClassEnum} Describes the class(type) of transaction.
   * @param description {String} The transaction description as submitted by the institution..
   * @param direction {module:model/TransactionDataAffordability.DirectionEnum} Identifies if the transaction is of debit or credit type.
   * @param id {String} Uniquely identifies the transaction.
   * @param institution {String} The id of the institution resource the transaction originated from.
   * @param links {module:model/AffordabilityTransactionLinks} 
  ...
  /**
   * Constructs a <code>TransactionDataAffordability</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransactionDataAffordability} obj Optional instance to populate.
   * @return {module:model/TransactionDataAffordability} The populated <code>TransactionDataAffordability</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('links'))
        obj.links = AffordabilityTransactionLinks.constructFromObject(data['links']);
   ...
   * @member {module:model/TransactionDataAffordability.ClassEnum} _class
   */
   ...
   * @member {module:model/TransactionDataAffordability.DirectionEnum} direction
   */
  ...
  /**
   * @member {module:model/AffordabilityTransactionLinks} links
   */
  ...
  /**
   * Identifies if a transaction is pending or posted. A pending transaction is an approved debit or credit transaction that has not been fully processed yet (i.e. has not been posted). Find out more about pending transaction and how to deal with them within your app. Note that pending transactions are not available for all institutions.
   * @member {module:model/TransactionDataAffordability.StatusEnum} status
   */
