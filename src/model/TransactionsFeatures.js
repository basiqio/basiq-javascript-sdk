...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BasiqApi.TransactionsFeatures = factory(root.BasiqApi.ApiClient, root.BasiqApi.SourceName);
  }
}(this, function(ApiClient, SourceName) {
  'use strict';

  /**
   * The TransactionsFeatures model module.
   * @module model/TransactionsFeatures
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>TransactionsFeatures</code>.
   * TransactionsFeatures describes set of institution transactions features
   * @alias module:model/TransactionsFeatures
   * @class
   * @param amount {Array.<module:model/SourceName>} TransactionAmount holds list of data source identifiers which are capable to fetch transaction amount.
   * @param balance {Array.<module:model/SourceName>} TransactionBalance holds list of data source identifiers which are capable to fetch account balance when transaction occured.
   * @param _class {Array.<module:model/SourceName>} Class holds list of data source identifiers which are capable to fetch transaction class.
   * @param _date {Array.<module:model/SourceName>} TransactionDate holds list of data source identifiers which are capable to fetch transaction date.
   * @param description {Array.<module:model/SourceName>} TransactionDescription holds list of data source identifiers which are capable to fetch transaction description.
   * @param status {Array.<module:model/SourceName>} TransactionStatus holds list of data source identifiers which are capable to fetch transaction status.
   */
  var exports = function(amount, balance, _class, _date, description, status) {
    this.amount = amount;
  ...
  /**
   * Constructs a <code>TransactionsFeatures</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransactionsFeatures} obj Optional instance to populate.
   * @return {module:model/TransactionsFeatures} The populated <code>TransactionsFeatures</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('amount'))
        obj.amount = ApiClient.convertToType(data['amount'], [SourceName]);
      if (data.hasOwnProperty('balance'))
        obj.balance = ApiClient.convertToType(data['balance'], [SourceName]);
      if (data.hasOwnProperty('class'))
        obj._class = ApiClient.convertToType(data['class'], [SourceName]);
      if (data.hasOwnProperty('date'))
        obj._date = ApiClient.convertToType(data['date'], [SourceName]);
      if (data.hasOwnProperty('description'))
        obj.description = ApiClient.convertToType(data['description'], [SourceName]);
      if (data.hasOwnProperty('status'))
        obj.status = ApiClient.convertToType(data['status'], [SourceName]);
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/SourceName>} amount
   */
   ...
   * @member {Array.<module:model/SourceName>} _class
   */
   ...
   * @member {Array.<module:model/SourceName>} _date
   */
