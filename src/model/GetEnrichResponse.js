...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EnrichData', 'model/ResourceLink'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EnrichData'), require('./ResourceLink'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.GetEnrichResponse = factory(root.BasiqApi.ApiClient, root.BasiqApi.EnrichData, root.BasiqApi.ResourceLink);
  }
}(this, function(ApiClient, EnrichData, ResourceLink) {
  'use strict';

  /**
   * The GetEnrichResponse model module.
   * @module model/GetEnrichResponse
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>GetEnrichResponse</code>.
   * @alias module:model/GetEnrichResponse
   * @class
   * @param _class {module:model/GetEnrichResponse.ClassEnum} Transaction Classification
   * @param data {module:model/EnrichData} 
   * @param direction {module:model/GetEnrichResponse.DirectionEnum} Direction of transaction
   * @param links {module:model/ResourceLink} 
   * @param type {String} Always \"enrich\"
   */
  var exports = function(_class, data, direction, links, type) {
    this._class = _class;
    this.data = data;
  ...
  /**
   * Constructs a <code>GetEnrichResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetEnrichResponse} obj Optional instance to populate.
   * @return {module:model/GetEnrichResponse} The populated <code>GetEnrichResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = EnrichData.constructFromObject(data['data']);
      if (data.hasOwnProperty('direction'))
        obj.direction = ApiClient.convertToType(data['direction'], 'String');
      if (data.hasOwnProperty('links'))
        obj.links = ResourceLink.constructFromObject(data['links']);
   ...
   * @member {module:model/GetEnrichResponse.ClassEnum} _class
   */
  exports.prototype._class = undefined;

  /**
   * @member {module:model/EnrichData} data
   */
  exports.prototype.data = undefined;

  /**
   * Direction of transaction
   * @member {module:model/GetEnrichResponse.DirectionEnum} direction
   */
  exports.prototype.direction = undefined;

  /**
   * @member {module:model/ResourceLink} links
   */
