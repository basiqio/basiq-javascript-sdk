...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccountClass', 'model/ConnectionAccountLinks'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AccountClass'), require('./ConnectionAccountLinks'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.AccountsData = factory(root.BasiqApi.ApiClient, root.BasiqApi.AccountClass, root.BasiqApi.ConnectionAccountLinks);
  }
}(this, function(ApiClient, AccountClass, ConnectionAccountLinks) {
  'use strict';

  /**
   * The AccountsData model module.
   * @module model/AccountsData
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>AccountsData</code>.
   * @alias module:model/AccountsData
   * @class
   * @param accountNo {String} Account number
   * @param availableFunds {String} Account available funds, nullable.
   * @param balance {String} Account balance, nullable.
   * @param _class {module:model/AccountClass} 
   * @param currency {String} Currency
   * @param id {String} Account identification.
   * @param lastUpdated {String} Account last updated date and time.
   * @param links {module:model/ConnectionAccountLinks} 
   * @param name {String} Account name.
   * @param status {module:model/AccountsData.StatusEnum} Account status.
   * @param type {String} Type always \"account\".
   */
  var exports = function(accountNo, availableFunds, balance, _class, currency, id, lastUpdated, links, name, status, type) {
  ...
  /**
   * Constructs a <code>AccountsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AccountsData} obj Optional instance to populate.
   * @return {module:model/AccountsData} The populated <code>AccountsData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('links'))
        obj.links = ConnectionAccountLinks.constructFromObject(data['links']);
  ...
  /**
   * @member {module:model/ConnectionAccountLinks} links
   */
  ...
  /**
   * Account status.
   * @member {module:model/AccountsData.StatusEnum} status
   */
