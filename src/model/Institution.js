...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/FeatureCondition', 'model/Features', 'model/InstitutionLogoResource', 'model/InstitutionPerformanceStats', 'model/ResourceLinks'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./FeatureCondition'), require('./Features'), require('./InstitutionLogoResource'), require('./InstitutionPerformanceStats'), require('./ResourceLinks'));
  } else {
    // Browser globals (root is window)
    if (!root.BasiqApi) {
      root.BasiqApi = {};
    }
    root.BasiqApi.Institution = factory(root.BasiqApi.ApiClient, root.BasiqApi.FeatureCondition, root.BasiqApi.Features, root.BasiqApi.InstitutionLogoResource, root.BasiqApi.InstitutionPerformanceStats, root.BasiqApi.ResourceLinks);
  }
}(this, function(ApiClient, FeatureCondition, Features, InstitutionLogoResource, InstitutionPerformanceStats, ResourceLinks) {
  'use strict';
   ...
   * @class
   * @param authorization {module:model/Institution.AuthorizationEnum} Institution authorization identifier
   * @param country {String} Institution country name
   * @param features {module:model/Features} 
   * @param id {String} Institution ID
   * @param institutionType {module:model/Institution.InstitutionTypeEnum} Institution type identifier
   * @param links {module:model/ResourceLinks} 
   * @param loginIdCaption {String} Login ID field caption that should be shown on UI
   * @param logo {module:model/InstitutionLogoResource} 
   * @param name {String} Institution name
   * @param passwordCaption {String} Password field caption that should be shown on UI
   * @param serviceName {String} Institution service name
   * @param serviceType {module:model/Institution.ServiceTypeEnum} Institution service name
   * @param shortName {String} Institution short name
   * @param stage {module:model/Institution.StageEnum} Institution stage identifier
   * @param stats {module:model/InstitutionPerformanceStats} 
   * @param status {module:model/FeatureCondition} 
   * @param tier {module:model/Institution.TierEnum} Institution tier identifier
   * @param type {module:model/Institution.TypeEnum} Resource type identifier. It is always \"institution\" for this model.
   */
  var exports = function(authorization, country, features, id, institutionType, links, loginIdCaption, logo, name, passwordCaption, serviceName, serviceType, shortName, stage, stats, status, tier, type) {
    ...
    this.links = links;
    this.loginIdCaption = loginIdCaption;
    this.logo = logo;
    this.name = name;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('forgottenPasswordUrl'))
        obj.forgottenPasswordUrl = ApiClient.convertToType(data['forgottenPasswordUrl'], 'String');
      ...
      if (data.hasOwnProperty('loginIdCaption'))
        obj.loginIdCaption = ApiClient.convertToType(data['loginIdCaption'], 'String');
      if (data.hasOwnProperty('logo'))
        obj.logo = InstitutionLogoResource.constructFromObject(data['logo']);
      if (data.hasOwnProperty('name'))
        obj.name = ApiClient.convertToType(data['name'], 'String');
      if (data.hasOwnProperty('passwordCaption'))
        obj.passwordCaption = ApiClient.convertToType(data['passwordCaption'], 'String');
      if (data.hasOwnProperty('secondaryLoginIdCaption'))
        obj.secondaryLoginIdCaption = ApiClient.convertToType(data['secondaryLoginIdCaption'], 'String');
      if (data.hasOwnProperty('securityCodeCaption'))
        obj.securityCodeCaption = ApiClient.convertToType(data['securityCodeCaption'], 'String');
      ...
      if (data.hasOwnProperty('stats'))
        obj.stats = InstitutionPerformanceStats.constructFromObject(data['stats']);
      if (data.hasOwnProperty('status'))
        obj.status = FeatureCondition.constructFromObject(data['status']);
   ...
   * @member {module:model/Institution.AuthorizationEnum} authorization
   */
   ...
   * @member {String} forgottenPasswordUrl
   */
  exports.prototype.forgottenPasswordUrl = undefined;
   ...
   * @member {module:model/Institution.InstitutionTypeEnum} institutionType
   */
  exports.prototype.institutionType = undefined;
   ...
   * @member {String} loginIdCaption
   */
  exports.prototype.loginIdCaption = undefined;

  /**
   * @member {module:model/InstitutionLogoResource} logo
   */
   ...
   * @member {String} passwordCaption
   */
  exports.prototype.passwordCaption = undefined;

  /**
   * Secondary loginID caption that should be shown on UI
   * @member {String} secondaryLoginIdCaption
   */
  exports.prototype.secondaryLoginIdCaption = undefined;

  /**
   * Security code caption that should be shown on UI
   * @member {String} securityCodeCaption
   */
  exports.prototype.securityCodeCaption = undefined;
  ...
  /**
   * Institution service name
   * @member {module:model/Institution.ServiceTypeEnum} serviceType
   */
   ...
   * @member {module:model/Institution.StageEnum} stage
   */
  exports.prototype.stage = undefined;

  /**
   * @member {module:model/InstitutionPerformanceStats} stats
   */
  exports.prototype.stats = undefined;

  /**
   * @member {module:model/FeatureCondition} status
   */
  exports.prototype.status = undefined;

  /**
   * Institution tier identifier
   * @member {module:model/Institution.TierEnum} tier
   */
  exports.prototype.tier = undefined;

  /**
   * Resource type identifier. It is always \"institution\" for this model.
   * @member {module:model/Institution.TypeEnum} type
   */
  ...
  /**
   * Allowed values for the <code>authorization</code> property.
   * @enum {String}
   * @readonly
   */
  exports.AuthorizationEnum = {
    /**
     * value: "user"
     * @const
     */
  ...
  /**
   * Allowed values for the <code>institutionType</code> property.
   * @enum {String}
   * @readonly
   */
  exports.InstitutionTypeEnum = {
    /**
     * value: "Bank"
     * @const
     */
