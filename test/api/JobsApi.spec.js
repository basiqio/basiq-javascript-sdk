    ...
    describe('JobsApi', function() {
      describe('getJobs', function() {
        it('should call getJobs successfully', function(done) {
          ...
          instance.getJobs(jobId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.JobData);
            expect(data.created).to.be.a('string');
            expect(data.created).to.be("2020-06-10T09:59:00Z");
            expect(data.id).to.be.a('string');
            expect(data.id).to.be("e9132638");
            expect(data.links).to.be.a(BasiqApi.JobsLinks);
                  expect(data.links.self).to.be.a('string');
              expect(data.links.self).to.be("/jobs/61723");
              expect(data.links.source).to.be.a('string');
              expect(data.links.source).to.be("");
            {
              let dataCtr = data.steps;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(BasiqApi.JobsStep);
                expect(data.result).to.be.a(BasiqApi.JobsResult);
                      expect(data.result.code).to.be.a('string');
                  expect(data.result.code).to.be("user-action-required");
                  expect(data.result.details).to.be.a('string');
                  expect(data.result.details).to.be("");
                  expect(data.result.title).to.be.a('string');
                  expect(data.result.title).to.be("");
                  expect(data.result.type).to.be.a('string');
                  expect(data.result.type).to.be("link");
                  expect(data.result.url).to.be.a('string');
                  expect(data.result.url).to.be("");
                expect(data.status).to.be.a('string');
                expect(data.status).to.be("success");
                expect(data.title).to.be.a('string');
                expect(data.title).to.be("retrieve-accounts");
            ...
            expect(data.updated).to.be("2020-06-10T09:59:00Z");
      ...
      describe('getUserJobs', function() {
        it('should call getUserJobs successfully', function(done) {
          // TODO: uncomment, update parameter values for getUserJobs call and complete the assertions
          /*
          var userId = "userId_example";
          var opts = {};
          opts.filter = "filter_example";

          instance.getUserJobs(userId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.JobsResponseResource);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(BasiqApi.JobsData);
                expect(data.created).to.be.a('string');
                expect(data.created).to.be("2020-06-10T09:59:00Z");
                expect(data.id).to.be.a('string');
                expect(data.id).to.be("e9132638");
                expect(data.institution).to.be.a(BasiqApi.JobsInstitution);
                      expect(data.institution.id).to.be.a('string');
                  expect(data.institution.id).to.be("AU00000");
                  expect(data.institution.links).to.be.a(BasiqApi.JobsLinks);
                        expect(data.institution.links.self).to.be.a('string');
                    expect(data.institution.links.self).to.be("/jobs/61723");
                    expect(data.institution.links.source).to.be.a('string');
                    expect(data.institution.links.source).to.be("");
