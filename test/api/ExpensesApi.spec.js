...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BasiqApi.ExpensesApi();
  });
    ...
    describe('ExpensesApi', function() {
      describe('getExpenses', function() {
        it('should call getExpenses successfully', function(done) {
          // TODO: uncomment, update parameter values for getExpenses call and complete the assertions
          /*
          var userId = "userId_example";
          var snapshotId = "snapshotId_example";

          instance.getExpenses(userId, snapshotId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.ExpensesResponse);
            expect(data.bankFees).to.be.a(BasiqApi.ClassResourceExpenses);
                  expect(data.bankFees.avgMonthly).to.be.a('string');
              expect(data.bankFees.avgMonthly).to.be("-421.00");
              {
                let dataCtr = data.bankFees.changeHistory;
                expect(dataCtr).to.be.an(Array);
                expect(dataCtr).to.not.be.empty();
                for (let p in dataCtr) {
                  let data = dataCtr[p];
                  expect(data).to.be.a(BasiqApi.ChangeHistoryExpensesClass);
                  expect(data.amount).to.be.a('string');
                  expect(data.amount).to.be("-11.00");
                  expect(data._date).to.be.a('string');
                  expect(data._date).to.be("2018-09");
  
                        }
              }
              expect(data.bankFees.summary).to.be.a('string');
              expect(data.bankFees.summary).to.be("monthly");
            expect(data.cashWithdrawals).to.be.a(BasiqApi.ClassResourceExpenses);
                  expect(data.cashWithdrawals.avgMonthly).to.be.a('string');
              expect(data.cashWithdrawals.avgMonthly).to.be("-421.00");
              {
                let dataCtr = data.cashWithdrawals.changeHistory;
                expect(dataCtr).to.be.an(Array);
                expect(dataCtr).to.not.be.empty();
                for (let p in dataCtr) {
                  let data = dataCtr[p];
              ...
              expect(data.cashWithdrawals.summary).to.be.a('string');
              expect(data.cashWithdrawals.summary).to.be("monthly");
            expect(data.coverageDays).to.be.a('number');
            expect(data.coverageDays).to.be(392);
            expect(data.externalTransfers).to.be.a(BasiqApi.ClassResourceExpenses);
                  expect(data.externalTransfers.avgMonthly).to.be.a('string');
              expect(data.externalTransfers.avgMonthly).to.be("-421.00");
              {
                let dataCtr = data.externalTransfers.changeHistory;
                expect(dataCtr).to.be.an(Array);
                expect(dataCtr).to.not.be.empty();
                for (let p in dataCtr) {
                  let data = dataCtr[p];
              ...
              expect(data.externalTransfers.summary).to.be.a('string');
              expect(data.externalTransfers.summary).to.be("monthly");
            expect(data.fromMonth).to.be.a('string');
            expect(data.fromMonth).to.be("2017-12");
            expect(data.id).to.be.a('string');
            expect(data.id).to.be("s55bf3");
            expect(data.links).to.be.a(BasiqApi.ExpensesLinks);
                  {
              ...
              expect(data.links.self).to.be("https://au-api.basiq.io/users/25c8d1ed77/expenses/s55bf4");
            expect(data.loanInterests).to.be.a(BasiqApi.ClassResourceExpenses);
                  expect(data.loanInterests.avgMonthly).to.be.a('string');
              expect(data.loanInterests.avgMonthly).to.be("-421.00");
              {
                let dataCtr = data.loanInterests.changeHistory;
                expect(dataCtr).to.be.an(Array);
                expect(dataCtr).to.not.be.empty();
                for (let p in dataCtr) {
                  let data = dataCtr[p];
              ...
              expect(data.loanInterests.summary).to.be.a('string');
              expect(data.loanInterests.summary).to.be("monthly");
            expect(data.loanRepayments).to.be.a(BasiqApi.ClassResourceExpenses);
                  expect(data.loanRepayments.avgMonthly).to.be.a('string');
              expect(data.loanRepayments.avgMonthly).to.be("-421.00");
              {
                let dataCtr = data.loanRepayments.changeHistory;
                expect(dataCtr).to.be.an(Array);
                expect(dataCtr).to.not.be.empty();
                for (let p in dataCtr) {
                  let data = dataCtr[p];
              ...
              expect(data.loanRepayments.summary).to.be.a('string');
              expect(data.loanRepayments.summary).to.be("monthly");
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(BasiqApi.PaymentsSummaryExpenses);
                expect(data.avgMonthly).to.be.a('string');
                expect(data.avgMonthly).to.be("-636.88");
                expect(data.division).to.be.a('string');
                expect(data.division).to.be("Education");
                expect(data.percentageTotal).to.be.a('number');
                expect(data.percentageTotal).to.be(-636.88);
                {
                  let dataCtr = data.subCategory;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                    expect(data).to.be.a(BasiqApi.SubCategoryExpenses);
                    expect(data.category).to.be.a(BasiqApi.CategoryDataExpenses);
                          expect(data.category.expenseClass).to.be.a(BasiqApi.ExpensesClass);
                            expect(data.category.expenseClass.classCode).to.be.a('string');
                        expect(data.category.expenseClass.classCode).to.be("0703030101");
                        expect(data.category.expenseClass.classTitle).to.be.a('string');
                        expect(data.category.expenseClass.classTitle).to.be("Non-electrical household appliances");
                        expect(data.category.expenseClass.divisionCode).to.be.a('string');
                        expect(data.category.expenseClass.divisionCode).to.be("04");
                        expect(data.category.expenseClass.divisionTitle).to.be.a('string');
                        expect(data.category.expenseClass.divisionTitle).to.be("Alcoholic beverages");
                    {
                    ...
                    expect(data.summary).to.be("monthly");
            ...
            expect(data.toMonth).to.be("2018-12");
            expect(data.type).to.be.a('string');
            expect(data.type).to.be("expenses");
      ...
      describe('postExpenses', function() {
        it('should call postExpenses successfully', function(done) {
          // TODO: uncomment, update parameter values for postExpenses call and complete the assertions
          /*
          var userId = "userId_example";
          var opts = {};
          opts.expensesPostRequest = new BasiqApi.ExpensesPostRequest();
          opts.expensesPostRequest.accounts = ["s55bf3","s55bf4"];
          opts.expensesPostRequest.fromMonth = "2019-05";
          opts.expensesPostRequest.toMonth = "2019-09";

          instance.postExpenses(userId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
