...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BasiqApi.AuthLinksApi();
  });

  describe('(package)', function() {
    describe('AuthLinksApi', function() {
      describe('deleteAuthLink', function() {
        it('should call deleteAuthLink successfully', function(done) {
          // TODO: uncomment, update parameter values for deleteAuthLink call
          /*
          var userId = "userId_example";

          instance.deleteAuthLink(userId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getAuthLink', function() {
        it('should call getAuthLink successfully', function(done) {
          // TODO: uncomment, update parameter values for getAuthLink call and complete the assertions
          /*
          var userId = "userId_example";

          instance.getAuthLink(userId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.AuthLinksResponseResource);
            expect(data.expiresAt).to.be.a('string');
            expect(data.expiresAt).to.be("2019-11-21T04:08:50Z");
            expect(data.id).to.be.a('string');
            expect(data.id).to.be("63448be4");
            expect(data.links).to.be.a(BasiqApi.AuthLinkLinks);
                  expect(data.links._public).to.be.a('string');
              expect(data.links._public).to.be("https://connect.basiq.io/63448be4");
              expect(data.links.self).to.be.a('string');
              expect(data.links.self).to.be("/users/ec4ea48d/auth_link");
            expect(data.mobile).to.be.a('string');
            expect(data.mobile).to.be("+61410000000");
            expect(data.type).to.be.a('string');
            expect(data.type).to.be("auth_link");
            expect(data.userId).to.be.a('string');
            expect(data.userId).to.be("ec4ea48d");
      ...
      describe('postAuthLink', function() {
        it('should call postAuthLink successfully', function(done) {
          // TODO: uncomment, update parameter values for postAuthLink call and complete the assertions
          /*
          var userId = "userId_example";
          var opts = {};
          opts.authLinksPostData = new BasiqApi.AuthLinksPostData();

          instance.postAuthLink(userId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.AuthLinksPostResponseResource);
            expect(data.expiresAt).to.be.a('string');
            expect(data.expiresAt).to.be("2019-11-21T04:08:50Z");
            expect(data.links).to.be.a(BasiqApi.AuthLinkLinks);
                  expect(data.links._public).to.be.a('string');
