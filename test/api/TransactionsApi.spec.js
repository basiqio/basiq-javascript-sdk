...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BasiqApi.TransactionsApi();
  });
    ...
    describe('TransactionsApi', function() {
      describe('getTransaction', function() {
        it('should call getTransaction successfully', function(done) {
          ...
          instance.getTransaction(userId, transactionId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.TransactionData);
            ...
            expect(data.connection).to.be("d3de1ca1");
            expect(data.description).to.be.a('string');
            expect(data.description).to.be("");
            expect(data.direction).to.be.a('string');
            expect(data.direction).to.be("credit");
            expect(data.enrich).to.be.a(BasiqApi.TransactionsEnrich);
                  expect(data.enrich.category).to.be.a(BasiqApi.TransactionsCategory);
                    expect(data.enrich.category.anzsic).to.be.a(BasiqApi.TransactionsAnzsic);
                      expect(data.enrich.category.anzsic._class).to.be.a(BasiqApi.TransactionsClass);
                        expect(data.enrich.category.anzsic._class.code).to.be.a('string');
                    expect(data.enrich.category.anzsic._class.code).to.be("4511");
                    expect(data.enrich.category.anzsic._class.title).to.be.a('string');
                    expect(data.enrich.category.anzsic._class.title).to.be("Cafes and Restaurants");
                  expect(data.enrich.category.anzsic.division).to.be.a(BasiqApi.TransactionsDivision);
                        expect(data.enrich.category.anzsic.division.code).to.be.a('string');
                    expect(data.enrich.category.anzsic.division.code).to.be("H");
                    expect(data.enrich.category.anzsic.division.title).to.be.a('string');
                    expect(data.enrich.category.anzsic.division.title).to.be("Accommodation and  Food Services");
                  expect(data.enrich.category.anzsic.group).to.be.a(BasiqApi.TransactionsGroup);
                        expect(data.enrich.category.anzsic.group.code).to.be.a('string');
                    expect(data.enrich.category.anzsic.group.code).to.be("451");
                    expect(data.enrich.category.anzsic.group.title).to.be.a('string');
                    expect(data.enrich.category.anzsic.group.title).to.be("Cafes, Restaurants and Takeaway Food Services");
                  expect(data.enrich.category.anzsic.subdivision).to.be.a(BasiqApi.TransactionsSubdivision);
                        expect(data.enrich.category.anzsic.subdivision.code).to.be.a('string');
                    expect(data.enrich.category.anzsic.subdivision.code).to.be("45");
                    expect(data.enrich.category.anzsic.subdivision.title).to.be.a('string');
                    expect(data.enrich.category.anzsic.subdivision.title).to.be("Food and Beverage Services");
              expect(data.enrich.location).to.be.a(BasiqApi.TransactionsLocation);
                    expect(data.enrich.location.country).to.be.a('string');
                expect(data.enrich.location.country).to.be("Australia");
                expect(data.enrich.location.formattedAddress).to.be.a('string');
                expect(data.enrich.location.formattedAddress).to.be("1/39 E Esplanade, Manly NSW 2095");
                expect(data.enrich.location.geometry).to.be.a(BasiqApi.TransactionsGeometry);
                      expect(data.enrich.location.geometry.lat).to.be.a('string');
                  expect(data.enrich.location.geometry.lat).to.be("-33.79988520000001");
                  expect(data.enrich.location.geometry.lng).to.be.a('string');
                  expect(data.enrich.location.geometry.lng).to.be("151.2858021");
                expect(data.enrich.location.postalCode).to.be.a('string');
                expect(data.enrich.location.postalCode).to.be("2095");
                expect(data.enrich.location.route).to.be.a('string');
                expect(data.enrich.location.route).to.be("E Esplanade");
                expect(data.enrich.location.routeNo).to.be.a('string');
                expect(data.enrich.location.routeNo).to.be("29");
                expect(data.enrich.location.state).to.be.a('string');
                expect(data.enrich.location.state).to.be("NSW");
                expect(data.enrich.location.suburb).to.be.a('string');
                expect(data.enrich.location.suburb).to.be("Manly");
              expect(data.enrich.merchant).to.be.a(BasiqApi.TransactionsMerchant);
                    expect(data.enrich.merchant.businessName).to.be.a('string');
                expect(data.enrich.merchant.businessName).to.be("Garfish Manly");
                expect(data.enrich.merchant.phoneNumber).to.be.a(BasiqApi.TransactionsPhoneNumber);
                      expect(data.enrich.merchant.phoneNumber.international).to.be.a('string');
                  expect(data.enrich.merchant.phoneNumber.international).to.be("+61 2 9977 0707");
                  expect(data.enrich.merchant.phoneNumber.local).to.be.a('string');
                  expect(data.enrich.merchant.phoneNumber.local).to.be("(02) 9977 0707");
                expect(data.enrich.merchant.website).to.be.a('string');
                expect(data.enrich.merchant.website).to.be("http://garfish.com.au/garfish-manly/");
            expect(data.id).to.be.a('string');
            expect(data.id).to.be("d3de1ca1");
            expect(data.institution).to.be.a('string');
            expect(data.institution).to.be("AU00000");
            expect(data.links).to.be.a(BasiqApi.TransactionLinks);
              ...
              expect(data.links.connection).to.be.a('string');
              expect(data.links.connection).to.be("");
              ...
              expect(data.links.self).to.be("https://au-api.basiq.io/users/6a52015e/transactions/2082c765");
      ...
      describe('getTransactions', function() {
        it('should call getTransactions successfully', function(done) {
          ...
          instance.getTransactions(userId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.TransactionsGetResource);
            ...
            expect(data.links).to.be.a(BasiqApi.TransactionsGetLinks);
                  expect(data.links.next).to.be.a('string');
              expect(data.links.next).to.be("https://au-api.basiq.io/users/6a52015e/transactions?next=bf1ec9d4");
              expect(data.links.self).to.be.a('string');
              expect(data.links.self).to.be("https://au-api.basiq.io/users/ea3a81/transactions");
