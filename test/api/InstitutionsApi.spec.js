...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BasiqApi.InstitutionsApi();
  });

  describe('(package)', function() {
    describe('InstitutionsApi', function() {
      describe('getInstitution', function() {
        it('should call getInstitution successfully', function(done) {
          // TODO: uncomment, update parameter values for getInstitution call and complete the assertions
          /*
          var institutionID = "institutionID_example";

          instance.getInstitution(institutionID, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.Institution);
            expect(data.authorization).to.be.a('string');
            expect(data.authorization).to.be("user");
            expect(data.country).to.be.a('string');
            expect(data.country).to.be("Australia");
            expect(data.features).to.be.a(BasiqApi.Features);
                  expect(data.features.accounts).to.be.a(BasiqApi.AccountsFeatures);
                    {
                  let dataCtr = data.features.accounts.accountHolder;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                    expect(data).to.be.a(BasiqApi.SourceName);
    
                          }
                }
                {
                  let dataCtr = data.features.accounts.accountNo;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                {
                  let dataCtr = data.features.accounts.availableFunds;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                {
                  let dataCtr = data.features.accounts.balance;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                {
                  let dataCtr = data.features.accounts.currency;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                {
                  let dataCtr = data.features.accounts.lastUpdated;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                {
                  let dataCtr = data.features.accounts.meta;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                {
                  let dataCtr = data.features.accounts.name;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
              ...
              {
                let dataCtr = data.features.login;
                expect(dataCtr).to.be.an(Array);
                expect(dataCtr).to.not.be.empty();
                for (let p in dataCtr) {
                  let data = dataCtr[p];
              ...
              expect(data.features.profile).to.be.a(BasiqApi.ProfileFeatures);
                    {
                  let dataCtr = data.features.profile.emailAddresses;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                {
                  let dataCtr = data.features.profile.firstName;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                {
                  let dataCtr = data.features.profile.fullName;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                {
                  let dataCtr = data.features.profile.lastName;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                {
                  let dataCtr = data.features.profile.middleName;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                {
                  let dataCtr = data.features.profile.phoneNumbers;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                {
                  let dataCtr = data.features.profile.physicalAddresses;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
              ...
              expect(data.features.transactions).to.be.a(BasiqApi.TransactionsFeatures);
                    {
                  let dataCtr = data.features.transactions.amount;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                {
                  let dataCtr = data.features.transactions.balance;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                {
                  let dataCtr = data.features.transactions._class;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                {
                  let dataCtr = data.features.transactions._date;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                {
                  let dataCtr = data.features.transactions.description;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                {
                  let dataCtr = data.features.transactions.status;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
            ...
            expect(data.forgottenPasswordUrl).to.be.a('string');
            expect(data.forgottenPasswordUrl).to.be("https://example.com/forgotten-password");
            expect(data.id).to.be.a('string');
            expect(data.id).to.be("AU00000");
            expect(data.institutionType).to.be.a('string');
            expect(data.institutionType).to.be("Bank");
            expect(data.links).to.be.a(BasiqApi.ResourceLinks);
                  expect(data.links.self).to.be.a('string');
              expect(data.links.self).to.be("");
            expect(data.loginIdCaption).to.be.a('string');
            expect(data.loginIdCaption).to.be("User name");
            expect(data.logo).to.be.a(BasiqApi.InstitutionLogoResource);
                  expect(data.logo.colors).to.be.a(BasiqApi.Colors);
                    expect(data.logo.colors.primary).to.be.a('string');
                expect(data.logo.colors.primary).to.be("");
              expect(data.logo.links).to.be.a(BasiqApi.LogoResourceLinks);
                    expect(data.logo.links.full).to.be.a('string');
                expect(data.logo.links.full).to.be("https://example.com/AU00000-full.svg");
                expect(data.logo.links.square).to.be.a('string');
                expect(data.logo.links.square).to.be("https://example.com/AU00000.svg");
              expect(data.logo.type).to.be.a('string');
              expect(data.logo.type).to.be("image");
            expect(data.name).to.be.a('string');
            expect(data.name).to.be("Hooli Bank");
            expect(data.passwordCaption).to.be.a('string');
            expect(data.passwordCaption).to.be("Password");
            expect(data.secondaryLoginIdCaption).to.be.a('string');
            expect(data.secondaryLoginIdCaption).to.be("Secondary login id");
            expect(data.securityCodeCaption).to.be.a('string');
            expect(data.securityCodeCaption).to.be("Security code");
            expect(data.serviceName).to.be.a('string');
            expect(data.serviceName).to.be("Personal Online Banking");
            expect(data.serviceType).to.be.a('string');
            expect(data.serviceType).to.be("Personal Banking");
            expect(data.shortName).to.be.a('string');
            expect(data.shortName).to.be("Hooli");
            expect(data.stage).to.be.a('string');
            expect(data.stage).to.be("live");
            expect(data.stats).to.be.a(BasiqApi.InstitutionPerformanceStats);
                  expect(data.stats.averageDurationMs).to.be.a(Object);
              expect(data.stats.averageDurationMs).to.be();
            expect(data.status).to.be.a(BasiqApi.FeatureCondition);
                expect(data.tier).to.be.a('string');
            expect(data.tier).to.be("3");
            expect(data.type).to.be.a('string');
            expect(data.type).to.be("institution");
      ...
      describe('getInstitutions', function() {
        it('should call getInstitutions successfully', function(done) {
          // TODO: uncomment, update parameter values for getInstitutions call and complete the assertions
          /*
          var opts = {};
          opts.filter = "filter_example";

          instance.getInstitutions(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.InstitutionsList);
            {
            ...
            expect(data.totalCount).to.be(1);
            expect(data.type).to.be.a(BasiqApi.ResponseFormat);
      ...
      describe('getPublicInstitutions', function() {
        it('should call getPublicInstitutions successfully', function(done) {
          // TODO: uncomment, update parameter values for getPublicInstitutions call and complete the assertions
          /*
          var opts = {};
          opts.filter = "filter_example";

          instance.getPublicInstitutions(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
