...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BasiqApi.ConnectionsApi();
  });
    ...
    describe('ConnectionsApi', function() {
      describe('deleteConnection', function() {
        it('should call deleteConnection successfully', function(done) {
          ...
          instance.deleteConnection(userId, connectionId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getConnection', function() {
        it('should call getConnection successfully', function(done) {
          ...
          instance.getConnection(userId, connectionId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.ConnectionGetResponseResource);
            expect(data.accounts).to.be.a(BasiqApi.AccountsContainer);
                  {
                let dataCtr = data.accounts.data;
                expect(dataCtr).to.be.an(Array);
                expect(dataCtr).to.not.be.empty();
                for (let p in dataCtr) {
                  let data = dataCtr[p];
                  expect(data).to.be.a(BasiqApi.AccountsData);
                  expect(data.accountNo).to.be.a('string');
                  expect(data.accountNo).to.be("105148119695");
                  expect(data.availableFunds).to.be.a('string');
                  expect(data.availableFunds).to.be("200.54");
                  expect(data.balance).to.be.a('string');
                  expect(data.balance).to.be("100.12");
                  expect(data._class).to.be.a(BasiqApi.AccountClass);
                        expect(data._class.meta).to.be.a(BasiqApi.Meta);
                        expect(data._class.product).to.be.a('string');
                    expect(data._class.product).to.be("saver");
                    expect(data._class.type).to.be.a('string');
                    expect(data._class.type).to.be("savings");
                  expect(data.currency).to.be.a('string');
                  expect(data.currency).to.be("AUD");
                  expect(data.id).to.be.a('string');
                  expect(data.id).to.be("319ae910");
                  expect(data.lastUpdated).to.be.a('string');
                  expect(data.lastUpdated).to.be("2017-09-28T11:15:09.756Z");
                  expect(data.links).to.be.a(BasiqApi.ConnectionAccountLinks);
                        expect(data.links.self).to.be.a('string');
                    expect(data.links.self).to.be("https://au-api.basiq.io/users/cd6fbd92/accounts/319ae910");
                    expect(data.links.transactions).to.be.a('string');
                    expect(data.links.transactions).to.be("https://au-api.basiq.io/users/ea3a81/transactions?filter=account.id.eq('s55bf3')");
                  expect(data.name).to.be.a('string');
                  expect(data.name).to.be("Business account");
              ...
              expect(data.accounts.type).to.be.a('string');
              expect(data.accounts.type).to.be("list");
            expect(data.id).to.be.a('string');
            expect(data.id).to.be("61723");
            expect(data.institution).to.be.a(BasiqApi.ConnectionInstitution);
                  expect(data.institution.id).to.be.a('string');
              expect(data.institution.id).to.be("AU00000");
              expect(data.institution.links).to.be.a(BasiqApi.ResourceLink);
                    expect(data.institution.links.self).to.be.a('string');
                expect(data.institution.links.self).to.be("");
              expect(data.institution.type).to.be.a('string');
              expect(data.institution.type).to.be("institution");
            expect(data.createdDate).to.be.a('string');
            expect(data.createdDate).to.be("2019-07-29T07:34:09Z");
            expect(data.lastUsed).to.be.a('string');
            expect(data.lastUsed).to.be("2020-06-22T11:15:09Z");
            expect(data.links).to.be.a(BasiqApi.GetConnectionLinks);
                  expect(data.links.accounts).to.be.a('string');
              expect(data.links.accounts).to.be("https://au-api.basiq.io/users/cd6fbd92/accounts?filter=institution.id.eq('AU00000')");
              expect(data.links.self).to.be.a('string');
              expect(data.links.self).to.be("https://au-api.basiq.io/users/cd6fbd92-0b12-43ba-a3c1-286dd5f4f396/connections/29523951");
              expect(data.links.transactions).to.be.a('string');
              expect(data.links.transactions).to.be("https://au-api.basiq.io/users/cd6fbd92/transactions?filter=institution.id.eq('AU00000')");
              expect(data.links.user).to.be.a('string');
              expect(data.links.user).to.be("https://au-api.basiq.io/users/cd6fbd92");
            expect(data.profile).to.be.a(BasiqApi.ConnectionProfile);
                  {
                let dataCtr = data.profile.emailAddresses;
                expect(dataCtr).to.be.an(Array);
                expect(dataCtr).to.not.be.empty();
                for (let p in dataCtr) {
                  let data = dataCtr[p];
              ...
              expect(data.profile.firstName).to.be.a('string');
              expect(data.profile.firstName).to.be("Gavin");
              expect(data.profile.fullName).to.be.a('string');
              expect(data.profile.fullName).to.be("Gavin Belson");
              expect(data.profile.lastName).to.be.a('string');
              expect(data.profile.lastName).to.be("Belson");
              expect(data.profile.middleName).to.be.a('string');
              expect(data.profile.middleName).to.be("");
              {
                let dataCtr = data.profile.phoneNumbers;
                expect(dataCtr).to.be.an(Array);
                expect(dataCtr).to.not.be.empty();
                for (let p in dataCtr) {
                  let data = dataCtr[p];
              ...
              {
                let dataCtr = data.profile.physicalAddresses;
                expect(dataCtr).to.be.an(Array);
                expect(dataCtr).to.not.be.empty();
                for (let p in dataCtr) {
                  let data = dataCtr[p];
                  expect(data).to.be.a(BasiqApi.PhysicalAddresses);
                  expect(data.addressLine1).to.be.a('string');
                  expect(data.addressLine1).to.be("13/91 Fisher Rd");
                  expect(data.addressLine2).to.be.a('string');
                  expect(data.addressLine2).to.be("");
                  expect(data.addressLine3).to.be.a('string');
                  expect(data.addressLine3).to.be("");
                  expect(data.city).to.be.a('string');
                  expect(data.city).to.be("Sydney");
                  expect(data.country).to.be.a('string');
                  expect(data.country).to.be("");
                  expect(data.countryCode).to.be.a('string');
                  expect(data.countryCode).to.be("AU");
                  expect(data.formattedAddress).to.be.a('string');
                  expect(data.formattedAddress).to.be("13/91 Fisher Rd, Dee Why NSW 2099, Australia");
                  expect(data.postcode).to.be.a('string');
                  expect(data.postcode).to.be("2099");
                  expect(data.state).to.be.a('string');
                  expect(data.state).to.be("NSW");
            ...
            expect(data.type).to.be.a('string');
            expect(data.type).to.be("connection");
      ...
      describe('getConnections', function() {
        it('should call getConnections successfully', function(done) {
          // TODO: uncomment, update parameter values for getConnections call and complete the assertions
          /*
          var userId = "userId_example";
          var opts = {};
          opts.filter = "filter_example";

          instance.getConnections(userId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.ConnectionsGetResponseResource);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(BasiqApi.ConnectionsData);
                expect(data.createdDate).to.be.a('string');
                expect(data.createdDate).to.be("2019-07-29T07:34:09Z");
                expect(data.id).to.be.a('string');
                expect(data.id).to.be("61723");
                ...
                expect(data.lastUsed).to.be.a('string');
                expect(data.lastUsed).to.be("2020-06-22T11:15:09Z");
                expect(data.links).to.be.a(BasiqApi.GetConnectionsLinks);
                      expect(data.links.accounts).to.be.a('string');
                  expect(data.links.accounts).to.be("https://au-api.basiq.io/users/cd6fbd92/accounts?filter=institution.id.eq('AU00000')");
                  ...
                  expect(data.links.self).to.be.a('string');
                  expect(data.links.self).to.be("https://au-api.basiq.io/users/cd6fbd92/connections/29523951");
                  expect(data.links.transactions).to.be.a('string');
                  expect(data.links.transactions).to.be("https://au-api.basiq.io/users/cd6fbd92/transactions?filter=institution.id.eq('AU00000')");
                expect(data.status).to.be.a('string');
                expect(data.status).to.be("active");
            ...
            expect(data.links).to.be.a(BasiqApi.ResourceLink);
                  expect(data.links.self).to.be.a('string');
              expect(data.links.self).to.be("");
            expect(data.type).to.be.a('string');
      ...
      describe('postConnection', function() {
        it('should call postConnection successfully', function(done) {
          // TODO: uncomment, update parameter values for postConnection call and complete the assertions
          /*
          var userId = "userId_example";
          var opts = {};
          opts.userConnectionsPostData = new BasiqApi.UserConnectionsPostData();
          opts.userConnectionsPostData.institution = new BasiqApi.InstitutionModel();
          opts.userConnectionsPostData.institution.id = "AU00000";
          opts.userConnectionsPostData.loginId = "gavinBelson";
          opts.userConnectionsPostData.password = "hooli2020";
          opts.userConnectionsPostData.secondaryLoginId = "";
          opts.userConnectionsPostData.securityCode = "";

          instance.postConnection(userId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.ConnectionResponseResource);
            expect(data.id).to.be.a('string');
            expect(data.id).to.be("29523951");
            expect(data.links).to.be.a(BasiqApi.ResourceLink);
                  expect(data.links.self).to.be.a('string');
              expect(data.links.self).to.be("");
            expect(data.type).to.be.a('string');
            expect(data.type).to.be("job");
      ...
      describe('refreshConnection', function() {
        it('should call refreshConnection successfully', function(done) {
          // TODO: uncomment, update parameter values for refreshConnection call and complete the assertions
          /*
          var userId = "userId_example";
          var connectionId = "connectionId_example";

          instance.refreshConnection(userId, connectionId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('refreshConnections', function() {
        it('should call refreshConnections successfully', function(done) {
          // TODO: uncomment, update parameter values for refreshConnections call and complete the assertions
          /*
          var userId = "userId_example";

          instance.refreshConnections(userId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.ConnectionsRefreshResource);
            {
              let dataCtr = data.data;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
      ...
      describe('updateConnection', function() {
        it('should call updateConnection successfully', function(done) {
          ...
          var connectionId = "connectionId_example";
          var opts = {};
          opts.userConnectionPostData = new BasiqApi.UserConnectionPostData();
          opts.userConnectionPostData.password = "1234";
          opts.userConnectionPostData.secondaryLoginId = "4321";
          opts.userConnectionPostData.securityCode = "";

          instance.updateConnection(userId, connectionId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
