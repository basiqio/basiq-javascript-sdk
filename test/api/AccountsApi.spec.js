...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BasiqApi.AccountsApi();
  });
    ...
    describe('AccountsApi', function() {
      describe('getAccount', function() {
        it('should call getAccount successfully', function(done) {
          ...
          instance.getAccount(userId, accountId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.AccountResponseResource);
            expect(data.accountHolder).to.be.a('string');
            expect(data.accountHolder).to.be("GAVIN BELSON");
            expect(data.accountNo).to.be.a('string');
            expect(data.accountNo).to.be("600000-157441965");
            expect(data.availableFunds).to.be.a('string');
            expect(data.availableFunds).to.be("420.28");
            expect(data.balance).to.be.a('string');
            expect(data.balance).to.be("356.50");
            ...
            expect(data.connection).to.be("8fce3b");
            ...
            expect(data.lastUpdated).to.be("2019-09-28T13:39:33Z");
            expect(data.links).to.be.a(BasiqApi.AccountLinks);
            ...
            expect(data.name).to.be("Master Savings");
            expect(data.status).to.be.a('string');
            expect(data.status).to.be("available");
            {
              let dataCtr = data.transactionIntervals;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(BasiqApi.AccountTransactionInterval);
                expect(data.from).to.be.a('string');
                expect(data.from).to.be("2018-07-01");
                expect(data.to).to.be.a('string');
                expect(data.to).to.be("2018-12-30");
      ...
      describe('getAccounts', function() {
        it('should call getAccounts successfully', function(done) {
          // TODO: uncomment, update parameter values for getAccounts call and complete the assertions
          /*
          var userId = "userId_example";

          instance.getAccounts(userId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.AccountsResponseResource);
            {
