...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BasiqApi.IncomeApi();
  });

  describe('(package)', function() {
    describe('IncomeApi', function() {
      describe('getIncome', function() {
        it('should call getIncome successfully', function(done) {
          // TODO: uncomment, update parameter values for getIncome call and complete the assertions
          /*
          var userId = "userId_example";
          var snapshotId = "snapshotId_example";

          instance.getIncome(userId, snapshotId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.IncomeResponse);
            ...
            expect(data.id).to.be("s55bf4");
            {
              let dataCtr = data.irregular;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(BasiqApi.IrregularSource);
                expect(data.ageDays).to.be.a('number');
                expect(data.ageDays).to.be(334);
                expect(data.amountAvg).to.be.a('string');
                expect(data.amountAvg).to.be("55.00");
                expect(data.avgMonthlyOccurence).to.be.a('string');
                expect(data.avgMonthlyOccurence).to.be("1");
                {
                  ...
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                    expect(data).to.be.a(BasiqApi.ChangeHistoryIncome);
                    expect(data.amount).to.be.a('string');
                    expect(data.amount).to.be("62.00");
                    expect(data._date).to.be.a('string');
                    expect(data._date).to.be("2018-10-13T20:03:37");
                    expect(data.source).to.be.a('string');
                    expect(data.source).to.be("savings interest cr bal - Account 1");
    
                          }
                }
                expect(data.current).to.be.a(BasiqApi.CurrentIrregularSource);
                      expect(data.current.amount).to.be.a('string');
                  expect(data.current.amount).to.be("62.00");
                  expect(data.current._date).to.be.a('string');
                  expect(data.current._date).to.be("2018-10-13T20:03:37");
                expect(data.frequency).to.be.a('string');
                expect(data.frequency).to.be("irregular");
                expect(data.noOccurrences).to.be.a('number');
                expect(data.noOccurrences).to.be(5);
                expect(data.source).to.be.a('string');
                expect(data.source).to.be("ctrlink carers 998r6789201610974v");

                      }
            }
            expect(data.links).to.be.a(BasiqApi.IncomeLinks);
                  {
              ...
              expect(data.links.self).to.be("https://au-api.basiq.io/users/25c8d1ed77/income/s55bf4");
            {
              let dataCtr = data.otherCredit;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(BasiqApi.OtherCreditSource);
                expect(data.ageDays).to.be.a('number');
                expect(data.ageDays).to.be(335);
                expect(data.amountAvg).to.be.a('string');
                expect(data.amountAvg).to.be("110.85");
                expect(data.avgMonthlyOccurence).to.be.a('string');
                expect(data.avgMonthlyOccurence).to.be("1");
                {
                  let dataCtr = data.changeHistory;
                ...
                expect(data.current).to.be.a(BasiqApi.CurrentOtherCreditSource);
                      expect(data.current.amount).to.be.a('string');
                  expect(data.current.amount).to.be("92.99");
                  expect(data.current._date).to.be.a('string');
                  expect(data.current._date).to.be("2019-10-29T00:00:00");
                  expect(data.current.otherCreditLabel).to.be.a('string');
                  expect(data.current.otherCreditLabel).to.be("regular income small amount");
                expect(data.frequency).to.be.a('string');
                expect(data.frequency).to.be("monthly");
                expect(data.noOccurrences).to.be.a('number');
                expect(data.noOccurrences).to.be(12);
                expect(data.source).to.be.a('string');
                expect(data.source).to.be("savings interest cr bal - Account 1");
            ...
            {
              let dataCtr = data.regular;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(BasiqApi.RegularSource);
                expect(data.ageDays).to.be.a('number');
                expect(data.ageDays).to.be(334);
                {
                  let dataCtr = data.changeHistory;
                ...
                expect(data.current).to.be.a(BasiqApi.CurrentRegularSource);
                      expect(data.current.amount).to.be.a('string');
                  expect(data.current.amount).to.be("18098.00");
                  expect(data.current._date).to.be.a('string');
                  expect(data.current._date).to.be("2018-11-30T09:23:37");
                  expect(data.current.nextDate).to.be.a('string');
                  expect(data.current.nextDate).to.be("2018-12-30T18:30:49");
                expect(data.frequency).to.be.a('string');
                expect(data.frequency).to.be("monthly");
                expect(data.irregularity).to.be.a(BasiqApi.IrregularityIncome);
                      {
                    let dataCtr = data.irregularity.gaps;
                    expect(dataCtr).to.be.an(Array);
                    expect(dataCtr).to.not.be.empty();
                    for (let p in dataCtr) {
                      let data = dataCtr[p];
                      expect(data).to.be.a(BasiqApi.Gap);
      
                            }
                  }
                  expect(data.irregularity.stability).to.be.a('string');
                  expect(data.irregularity.stability).to.be("100.00");
                expect(data.previous3Months).to.be.a(BasiqApi.Previous3MonthsIncome);
                      expect(data.previous3Months.amountAvg).to.be.a('string');
                  expect(data.previous3Months.amountAvg).to.be("18098.00");
                  expect(data.previous3Months.amountAvgMonthly).to.be.a('string');
                  expect(data.previous3Months.amountAvgMonthly).to.be("18098.00");
                  expect(data.previous3Months.variance).to.be.a('string');
                  expect(data.previous3Months.variance).to.be("0.00");
                expect(data.source).to.be.a('string');
                expect(data.source).to.be("payroll wfrms 15439393");

                      }
            }
            expect(data.summary).to.be.a(BasiqApi.IncomeSummary);
                  expect(data.summary.irregularIncomeAvg).to.be.a('string');
              expect(data.summary.irregularIncomeAvg).to.be("55.00");
              expect(data.summary.regularIncomeAvg).to.be.a('string');
              expect(data.summary.regularIncomeAvg).to.be("18098.00");
              expect(data.summary.regularIncomeYTD).to.be.a('string');
              expect(data.summary.regularIncomeYTD).to.be("90490.00");
              expect(data.summary.regularIncomeYear).to.be.a('string');
              expect(data.summary.regularIncomeYear).to.be("217176.00");
            expect(data.toMonth).to.be.a('string');
            expect(data.toMonth).to.be("2020-03");
            expect(data.type).to.be.a('string');
            expect(data.type).to.be("income");
      ...
      describe('postIncome', function() {
        it('should call postIncome successfully', function(done) {
          // TODO: uncomment, update parameter values for postIncome call and complete the assertions
          /*
          var userId = "userId_example";
          var opts = {};
          opts.incomePostRequest = new BasiqApi.IncomePostRequest();
          opts.incomePostRequest.accounts = ["s55bf3","s55bf4"];
          opts.incomePostRequest.fromMonth = "2019-05";
          opts.incomePostRequest.toMonth = "2019-09";

          instance.postIncome(userId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
