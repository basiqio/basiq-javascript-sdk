...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BasiqApi.UsersApi();
  });
    ...
    describe('UsersApi', function() {
      describe('createUser', function() {
        it('should call createUser successfully', function(done) {
          ...
          /*
          var user = new BasiqApi.CreateUser();
          user.email = "gavin@hooli.com";
          user.mobile = "+61410888999";

          instance.createUser(user, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.UserPostResponse);
            expect(data.email).to.be.a('string');
            expect(data.email).to.be("gavin@hooli.com");
            expect(data.id).to.be.a('string');
            expect(data.id).to.be("e1956419");
            expect(data.links).to.be.a(BasiqApi.ResourceLink);
                  expect(data.links.self).to.be.a('string');
              expect(data.links.self).to.be("");
            expect(data.mobile).to.be.a('string');
            expect(data.mobile).to.be("+61410888999");
      ...
      describe('getUser', function() {
        it('should call getUser successfully', function(done) {
          ...
          instance.getUser(userId, function(error, data, response) {
            ...
            // TODO: update response assertions
            expect(data).to.be.a(BasiqApi.UserGetResponse);
            expect(data.accounts).to.be.a(BasiqApi.GetUserAccount);
                  expect(data.accounts.count).to.be.a('number');
              expect(data.accounts.count).to.be(7);
              {
                ...
                for (let p in dataCtr) {
                  let data = dataCtr[p];
                  expect(data).to.be.a(BasiqApi.GetUserAccountData);
                  expect(data.id).to.be.a('string');
                  expect(data.id).to.be("aaaf2c3b");
                  expect(data.links).to.be.a(BasiqApi.ResourceLink);
                        expect(data.links.self).to.be.a('string');
                    expect(data.links.self).to.be("");
                  expect(data.type).to.be.a('string');
            ...
            expect(data.business).to.be.a('string');
            expect(data.business).to.be("");
            expect(data.connections).to.be.a(BasiqApi.GetUserConnection);
                  expect(data.connections.count).to.be.a('number');
              expect(data.connections.count).to.be(5);
              {
                let dataCtr = data.connections.data;
                expect(dataCtr).to.be.an(Array);
                expect(dataCtr).to.not.be.empty();
                for (let p in dataCtr) {
                  let data = dataCtr[p];
                  expect(data).to.be.a(BasiqApi.GetUserConnectionData);
                  expect(data.id).to.be.a('string');
                  expect(data.id).to.be("aaaf2c3b");
                  expect(data.links).to.be.a(BasiqApi.ResourceLink);
                        expect(data.links.self).to.be.a('string');
              ...
              expect(data.connections.type).to.be.a('string');
              expect(data.connections.type).to.be("list");
            expect(data.email).to.be.a('string');
            expect(data.email).to.be("gavin@hooli.com");
            expect(data.id).to.be.a('string');
            expect(data.id).to.be("ea3a81");
            expect(data.links).to.be.a(BasiqApi.GetUserLinks);
                  expect(data.links.accounts).to.be.a('string');
              expect(data.links.accounts).to.be("");
              expect(data.links.authLink).to.be.a('string');
              expect(data.links.authLink).to.be("");
              expect(data.links.connections).to.be.a('string');
              expect(data.links.connections).to.be("");
              expect(data.links.self).to.be.a('string');
              expect(data.links.self).to.be("");
              expect(data.links.transactions).to.be.a('string');
              expect(data.links.transactions).to.be("");
            expect(data.mobile).to.be.a('string');
            expect(data.mobile).to.be("+61410888666");
      ...
      describe('updateUser', function() {
        it('should call updateUser successfully', function(done) {
          ...
          /*
          var userId = "userId_example";
          var user = new BasiqApi.UpdateUser();
          user.email = "gavin@hooli.com";
          user.mobile = "+61410888666";

          instance.updateUser(userId, user, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
