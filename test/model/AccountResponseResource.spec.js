...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccountResponseResource', function() {
      beforeEach(function() {
        instance = new BasiqApi.AccountResponseResource();
      });

      it('should create an instance of AccountResponseResource', function() {
        // TODO: update the code to test AccountResponseResource
        expect(instance).to.be.a(BasiqApi.AccountResponseResource);
      });
      ...
      it('should have the property transactionIntervals (base name: "transactionIntervals")', function() {
        // TODO: update the code to test the property transactionIntervals
        expect(instance).to.have.property('transactionIntervals');
        // expect(instance.transactionIntervals).to.be(expectedValueLiteral);
      });
