...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransactionDataAffordability', function() {
      beforeEach(function() {
        instance = new BasiqApi.TransactionDataAffordability();
      });

      it('should create an instance of TransactionDataAffordability', function() {
        // TODO: update the code to test TransactionDataAffordability
        expect(instance).to.be.a(BasiqApi.TransactionDataAffordability);
      });
