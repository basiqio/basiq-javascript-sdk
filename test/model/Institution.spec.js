...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Institution', function() {
      beforeEach(function() {
        instance = new BasiqApi.Institution();
      });

      it('should create an instance of Institution', function() {
        // TODO: update the code to test Institution
        expect(instance).to.be.a(BasiqApi.Institution);
      });
      ...
      it('should have the property forgottenPasswordUrl (base name: "forgottenPasswordUrl")', function() {
        // TODO: update the code to test the property forgottenPasswordUrl
        expect(instance).to.have.property('forgottenPasswordUrl');
        // expect(instance.forgottenPasswordUrl).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property institutionType (base name: "institutionType")', function() {
        // TODO: update the code to test the property institutionType
        expect(instance).to.have.property('institutionType');
        // expect(instance.institutionType).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property loginIdCaption (base name: "loginIdCaption")', function() {
        // TODO: update the code to test the property loginIdCaption
        expect(instance).to.have.property('loginIdCaption');
        // expect(instance.loginIdCaption).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property passwordCaption (base name: "passwordCaption")', function() {
        // TODO: update the code to test the property passwordCaption
        expect(instance).to.have.property('passwordCaption');
        // expect(instance.passwordCaption).to.be(expectedValueLiteral);
      });

      it('should have the property secondaryLoginIdCaption (base name: "secondaryLoginIdCaption")', function() {
        // TODO: update the code to test the property secondaryLoginIdCaption
        expect(instance).to.have.property('secondaryLoginIdCaption');
        // expect(instance.secondaryLoginIdCaption).to.be(expectedValueLiteral);
      });

      it('should have the property securityCodeCaption (base name: "securityCodeCaption")', function() {
        // TODO: update the code to test the property securityCodeCaption
        expect(instance).to.have.property('securityCodeCaption');
        // expect(instance.securityCodeCaption).to.be(expectedValueLiteral);
      });
