...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransactionData', function() {
      beforeEach(function() {
        instance = new BasiqApi.TransactionData();
      });

      it('should create an instance of TransactionData', function() {
        // TODO: update the code to test TransactionData
        expect(instance).to.be.a(BasiqApi.TransactionData);
      });
      ...
      it('should have the property enrich (base name: "enrich")', function() {
        // TODO: update the code to test the property enrich
        expect(instance).to.have.property('enrich');
        // expect(instance.enrich).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property subClass (base name: "subClass")', function() {
        // TODO: update the code to test the property subClass
        expect(instance).to.have.property('subClass');
        // expect(instance.subClass).to.be(expectedValueLiteral);
      });
